  ...
  <div class="__ag__friend-main__" @click="__ag__clickLive__">
    ...
    >
      <scroller
        ...
        v-if="friendList2 && friendList2.length > 0"
      >
        <refresh
        ...
        <div
          class="__ag__friend-item__"
          v-for="(item, index) in friendList2"
          :key="'friend-' + item.id"
        >
          <div
            v-if="index == 0 || item.index != friendList2[index - 1].index"
            class="first-letter"
          >
...
.__ag__msg-search__ {
  ...
  align-items: center;
  background-color: @primaryInputBg;
}
