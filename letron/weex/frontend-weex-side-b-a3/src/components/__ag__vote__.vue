        ...
        <div class="__ag__voteprogress__">
          <div class="__ag__voteprogress_item__" :style="{ flex: vote.classA }">
            <div
              ...
              :class="[
                env.code == 'bl' ? '__ag__voteprogressleft_bl__' : '',
                vote.classA == '.3' ? '__ag__voteprogressleft_3__' : '',
                vote.classA == '.3' && env.code == 'bl'
                  ? '__ag__voteprogressleft_3_bl__'
                  : '',
                vote.classA == 'bbg' || vote.classA == 'a3'
                  ? '__ag__voteprogressleft_bbg__'
                  : '',
              ]"
            >
            ...
            <div
              ...
              :class="[
                env.code == 'bl' ? '__ag__vote_lf_line_bl__' : '',
                vote.classA == '.3' ? '__ag__vote_linea_3__' : '',
                vote.classA == '.3' && env.code == 'bl'
                  ? '__ag__vote_linea_3_bl__'
                  : '',
              ]"
            ></div>
          </div>
          <div class="__ag__voteprogress_item__" :style="{ flex: vote.classB }">
            <div
              ...
              :class="[
                vote.classB == '.3' ? '__ag__voteprogressright_3__' : '',
              ]"
            >
              <text class="__ag__voteprogress_text__"
                >{{ vote.progressB }}%</text
            ...
            <div
              ...
              :class="[vote.classB == '.3' ? '__ag__vote_lineb_3__' : '']"
            ></div>
          </div>
        </div>
      ...
      <div class="__ag__votebottom__">
        <div class="__ag__bottomleft__">
          <text
            ...
            v-if="vote.isCountA"
            :class="[
              env.code == 'bl' ? '__ag__votebottom_lf_text_bl__' : '',
              !vote.isCountB ? 'pointer' : '',
            ]"
            @click="onCount(1)"
            >{{ voteName }}</text
          >
  ...
  methods: {
    ...
    async onCount(answer) {
      ...
      try {
        ...
        console.log("resp==", util.toString(resp))
        if (resp.success) {
          util.message("投票成功")
          this.answer = answer
    ...
    __ag__count__() {
      ...
      if (this.countAB != 0) {
        ...
        console.log("classB======", classA, classB)
      } else {
        this.vote.classA = ".5"
        this.vote.classB = ".5"
      }
...
.__ag__votecontent__ {
  ...
  box-shadow: 2px 2px 4px @black30;
  padding-bottom: 40px;
}
.__ag__votetitle__ {
  width: 660px;
...
.__ag__voteprogressleft_bl__ {
  background-image: linear-gradient(to right, @yellow11, @yellow12);
}
.__ag__voteprogressleft_3__ {
  background-image: linear-gradient(to right, @red23, @red23);
}
.__ag__voteprogressleft_3_bl__ {
  background-image: linear-gradient(to right, @yellow11, @yellow11);
}
.__ag__voteprogressleft_bbg__ {
  background-image: linear-gradient(to right, @primary, @primaryLinearEnd);
}
...
.__ag__vote_lf_line_bl__ {
  background-color: @yellow14;
}
.__ag__vote_linea_3__ {
  background-color: @red23;
}
.__ag__vote_linea_3_bl__ {
  background-color: @yellow11;
}
.__ag__votecount__ {
  color: @white;
  font-size: 16wx;
...
.__ag__voteprogressright_3__ {
  background-image: linear-gradient(to right, @green12, @green12);
}
...
.__ag__votebottom_lf_text_bl__ {
  background-image: linear-gradient(to right, @yellow11, @yellow13);
}
.__ag__bottomright__ {
  flex: 1;
  flex-direction: row;
