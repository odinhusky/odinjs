<template>
  <div class="__ag__enddatalive__">
    <image class="__ag__endbackimg__" :src="handleImgPath(url)"></image>
    <div class="__ag__uptime_content__">
      <div
        class="__ag__endcontent__"
        v-if="info && info.id"
        @swipe="handleSwipe"
      >
        <div class="__ag__endsaishi__">
          ...
          <div class="__ag__endscore__">
            <div class="__ag__enddate__">
              ...
              <text class="__ag__enddatetext__">{{
        ...
        <div class="__ag__endteamstatus__">
          <text class="__ag__endteamstatustext__">{{
            a__ag__var__.status[info.status]
          }}</text>
        </div>
      </div>
