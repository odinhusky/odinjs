  ...
  >
    ...
    <scroller
      ...
      :class="[
        ...
        listFaq && listFaq.length && ipx ? '__ag__msgchatscroller_faq_ipx__' : '',
      ]"
    ...
    >
      ...
      >
        ...
        >
          <text
            >「{{
              n.senderName || (n.joinMap && n.joinMap.u && n.joinMap.u.userNicename)
            }}」</text
          >
        ...
        >
          ...
          <ag-userimg
            ...
            :name="senderName(n)"
            :isNotImage="true"
            :avatar="(n.joinMap && n.joinMap.u && n.joinMap.u.avatar) || n.avatar"
          ></ag-userimg>
          ...
          >
            ...
            >
              <div v-for="(ji, index) in n.jsonContent" :key="'jc' + n.id + '-' + index">
                <!-- 文本类型 -->
                <text
                  v-if="ji.type == 'text'"
              ...
              <div
                ...
                @click="onbangding"
                v-if="iszb && n.type == vars.TYPE_BANG && user && user.userType == 3"
              >
            ...
            >
            <text
              v-if="msgRight(n) && !n.hi && n.contentType != 3 && n.contentType != 5"
    ...
    <div class="__ag__chatemotion__" v-if="isemotion" :class="[ipx ? 'emotion-ipx' : '']">
...
export default {
  ...
  methods: {
    ...
    async __ag__ofUpmsg__() {
      ...
      this.hasFriend =
        this.ofUpinfo.joinMap && this.ofUpinfo.joinMap.f && this.ofUpinfo.joinMap.f.id;
    ...
    __ag__ofUpAddBing__(list) {
      if (this.hasFriend && this.user && this.user.userType == 3) {
        let item = {
          content: "绑定电话号码，聊天消息不丟失，体验更多功能，还有机会获得神秘礼物！",
          type: vars.TYPE_BANG,
          messageType: 3,
          contentType: 1,
          senderName:
