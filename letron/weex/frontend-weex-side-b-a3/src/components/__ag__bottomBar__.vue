<template>
  <div class="__ag__bottombar__" :class="[ipx ? 'ipx' : '']">
    <div class="__ag__bottombardiv__" @click.stop="__ag__onIndex__(1)">
      <text v-if="topTab != 1" class="agiconfont __ag__iconfonttext__"
        >&#xe66e;</text
      >
      <text v-else class="agiconfont __ag__iconfonttext__ __ag__tab__">{{
        env.code != "zfv2" ? "&#xe678;" : "&#xe66e;"
      }}</text>
      <text
        class="__ag__bottombartext__"
        :class="[topTab == '1' ? '__ag__tab__' : '']"
        >首页</text
      >
    </div>
    <div class="__ag__bottombardiv__" @click.stop="__ag__onIndex__(2)">
      <text v-if="topTab != 2" class="agiconfont __ag__iconfonttext__"
        >&#xe668;</text
      >
      <text v-else class="agiconfont __ag__iconfonttext__ __ag__tab__">{{
        env.code != "zfv2" ? "&#xe67c;" : "&#xe668;"
      ...
      <text
        class="__ag__bottombartext__"
        :class="[topTab == '2' ? '__ag__tab__' : '']"
        >比赛</text
      >
    </div>
    <div class="__ag__bottombardiv__" @click.stop="__ag__onIndex__(3)">
      <text v-if="topTab != 3" class="agiconfont __ag__iconfonttext__"
        >&#xe66a;</text
      >
      <text v-else class="agiconfont __ag__iconfonttext__ __ag__tab__">{{
        env.code != "zfv2" ? "&#xe67b;" : "&#xe66a;"
    ...
    <div class="__ag__bottombardiv__" @click.stop="__ag__onIndex__(4)">
      <text v-if="topTab != 4" class="agiconfont __ag__iconfonttext__"
        >&#xe66b;</text
      >
      <text v-else class="agiconfont __ag__iconfonttext__ __ag__tab__">{{
        env.code != "zfv2" ? "&#xe67a;" : "&#xe66b;"
      ...
      <text
        class="__ag__bottombartext__"
        :class="[topTab == '4' ? '__ag__tab__' : '']"
        >通讯录</text
      >
    </div>
    <div class="__ag__bottombardiv__" @click.stop="__ag__onIndex__(5)">
      <text v-if="topTab != 5" class="agiconfont __ag__iconfonttext__"
        >&#xe671;</text
      >
      <text v-else class="agiconfont __ag__iconfonttext__ __ag__tab__">{{
        env.code != "zfv2" ? "&#xe677;" : "&#xe671;"
