<template>
  ...
  <div
    ...
    @click.self="onMatch(a__ag__dateItem__)"
  >
    <div v-if="!a__ag__dateItem__.lives" class="__ag__item__">
      <div class="__ag__item-lf__">
        <text class="__ag__match-begin__">{{
          util.formatTime(a__ag__dateItem__.beginTime)
        }}</text>
        <text class="__ag__match-name-text__">{{
          (a__ag__dateItem__ &&
      ...
      <div class="__ag__item-center__">
        <div class="__ag__match-team-a-text__">
          ...
          <team-logo
            teamType="1"
            :teamFlag="a__ag__dateItem__.teamFlaga"
            :teamName="a__ag__dateItem__.teamNamea"
            class="__ag__team__"
          ></team-logo>
        ...
        <div class="__ag__match-team-a-text__ __ag__match-team-b-text__">
          ...
          <team-logo
            teamType="2"
            :teamFlag="a__ag__dateItem__.teamFlagb"
            :teamName="a__ag__dateItem__.teamNameb"
            class="__ag__team__"
          ></team-logo>
          <text class="__ag__match-team-teamName__">{{
      ...
      <div class="__ag__item-rg__">
        <div class="__ag__match-category-status__">
          <div
            v-if="a__ag__dateItem__.lives && a__ag__dateItem__.lives.length > 0"
            style="
              display: flex;
              align-items: center;
        ...
        <text
          v-if="isAppoint"
          class="agiconfont appoint-icon"
          @click="onMakeAppointment"
          >&#xe705;</text
        >
        <div
          v-if="isUserMatch"
          class="cancel-appointe"
    ...
    <div v-else class="__ag__item-lives__">
      ...
      <div
        class="__ag__item-lives-users__"
        v-if="
          a__ag__dateItem__ &&
...
export default {
  ...
  computed: {
    isAppoint() {
      if (
        this.a__ag__dateItem__ &&
        this.a__ag__dateItem__.lives &&
        this.a__ag__dateItem__.lives.length > 0
      ) {
        return false
      }
  ...
  methods: {
    ...
    // 前往直播間: 主播私聊頁籤
    __ag__toLisve__(li) {
      console.log("@@ 有進來嗎 li=>", JSON.stringify(li))
      if (!li.uid) {
        return
      }
      ...
      try {
        ...
        if (resp.success) {
          ...
          bc.postMessage("cancelAppoint", {
            scheduleId: this.a__ag__dateItem__.id,
          })
