...
function SportApi(method, form){
      ...
      if (WXEnvironment.platform != "Web") {
		...
		url = env.host + url
    if (method === "listSwiper") {
      console.log("@@ listSwiper rd=>", rd)
      console.log("@@ listSwiper token=>", token)
      console.log("@@ listSwiper guestToken=>", guestToken)
      console.log("@@ listSwiper aghash=>", aghash)
      console.log("@@ listSwiper url=>", url)
    }
