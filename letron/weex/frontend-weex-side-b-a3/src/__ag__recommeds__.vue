<template>
  ...
  >
    ...
    <div class="__ag__recommeds-tabs__">
      <div
        class="__ag__recom-tabs-item__"
        :class="[tab == item.id ? 'tab-select' : '', 'tab-item-' + item.id]"
    ...
    <div class="__ag__recommeds-content__">
      ...
      >
        <div
          class="__ag__recommeds-item__"
          :class="[sliderIndex == 0 ? 'show' : 'hide']"
        >
          <scroller
            class="__ag__recommeds-list"
          ...
          <text
            v-if="!recommedNewList || !recommedNewList.length"
            class="no-data-text"
            >暂无数据</text
          >
        </div>
        ...
        >
          ...
          <scroller
            class="__ag__recommeds-list"
            show-scrollbar="false"
            v-if="recommedRankList && recommedRankList.length > 0"
          >
            <ag-recommed-rank-item
              v-for="(item, index) in recommedRankList"
              :index="index"
              :item="item"
              :key="item.id"
            ></ag-recommed-rank-item>
