  ...
  <div class="__ag__uplive__" :class="[ipx ? 'ipx' : '']" @swipe="handleSwipe">
    ...
    <div class="__ag__uplivetabs__">
      ...
      >
        <image
          resize="contain"
          :src="handleImgPath('active-all.png')"
          class="__ag__tabs_image__"
          v-if="item.name == '全部' && tab == item.id"
        />
        <image
          resize="contain"
          :src="handleImgPath('tab-all.png')"
          class="__ag__tabs_image__"
          v-if="item.name == '全部' && tab != item.id"
        />
        <image
          resize="contain"
          :src="handleImgPath('active-remen.png')"
          class="__ag__tabs_image__"
          v-if="item.name == '热门' && tab == item.id"
        />
        <image
          resize="contain"
          :src="handleImgPath('tab-remen.png')"
          class="__ag__tabs_image__"
          v-if="item.name == '热门' && tab != item.id"
        />
        <image
          resize="contain"
          :src="handleImgPath('active-lanqiu.png')"
          class="__ag__tabs_image__"
          v-if="item.name == '篮球' && tab == item.id"
        />
        <image
          resize="contain"
          :src="handleImgPath('tab-lanqiu.png')"
          class="__ag__tabs_image__"
          v-if="item.name == '篮球' && tab != item.id"
        />
        <image
          resize="contain"
          :src="handleImgPath('active-zuqiu.png')"
          class="__ag__tabs_image__"
          v-if="item.name == '足球' && tab == item.id"
        />
        <image
          resize="contain"
          :src="handleImgPath('tab-zuqiu.png')"
          class="__ag__tabs_image__"
          v-if="item.name == '足球' && tab != item.id"
        />
        <image
          resize="contain"
          :src="handleImgPath('active-qt.png')"
          class="__ag__tabs_image__"
          v-if="item.name == '其他' && tab == item.id"
        />
        <image
          resize="contain"
          :src="handleImgPath('tab-qt.png')"
          class="__ag__tabs_image__"
          v-if="item.name == '其他' && tab != item.id"
        />
        <text
          class="__ag__tabstext__"
          :class="[tab == item.id ? '__ag__tabselecttext__' : '']"
          >{{ item.name }}</text
        >
      </div>
    </div>
