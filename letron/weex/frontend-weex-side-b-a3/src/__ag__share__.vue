  ...
  <div class="__ag__share__" :class="[ipx ? 'share-ipx' : '']">
    <div class="__ag__shareb__">
      <image
        ...
        resize="cover"
        :src="handleImgPath('share-b.png')"
      ></image>
      <div class="__ag__sharecontent__">
        <image
          class="__ag__shareimg__"
          v-if="env.brand == 'bl'"
          :src="handleImgPath('share-1.png')"
        ></image>
        <image
          class="__ag__shareimg__"
          v-else
          :src="handleImgPath('shareBg.png')"
        ></image>
        <div
          ...
          :class="[
            ...
            env.brand == 'bbg' && !ipx ? '__ag__shareqr_item_ipx__' : '',
          ]"
        >
          <web
            ref="webview"
