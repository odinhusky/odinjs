<template>
  <div class="__ag__nvideo-main__" @click="__ag__click__">
    ...
    <!-- 顶部控件 -->
    <div
      class="__ag__control_top__"
      :class="[isFull ? '__ag__control_full__' : '']"
      ref="__ag__close__"
      :style="controlStyle"
      @click.stop=""
    >
      <div class="__ag__livetitle__" :style="controlStyle">
        <ag-uptitle
          ...
          :item="upinfo"
          :amount="
            upinfo.joinMap && upinfo.joinMap.room && upinfo.joinMap.room.amount
          "
          :score="
            upinfo.joinMap &&
            upinfo.joinMap.streamer &&
            upinfo.joinMap.streamer.score
          "
          :user="a__ag__user__"
          @close="onclose"
        ></ag-uptitle>
