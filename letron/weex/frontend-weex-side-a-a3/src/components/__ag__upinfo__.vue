  ...
  <div class="__ag__upinfo__" v-if="item && item.id">
    <div class="__ag__upinfotitle__">
      <div class="__ag__upinfoleft__">
        ...
        <div class="__ag__upinfoname__">
          <text class="__ag__upinfonametext__">{{ item.userNicename }}</text>
          <div class="__ag__upinfofollow__">
            <image
              :src="__ag__url__('static/a3/hot.png')"
              class="__ag__fire__"
            ></image>
            <text class="__ag__upinfofollowtext__">{{
              a__ag__util__.numberReadable(amount)
            }}</text>
            <text class="iconfont __ag__like__">&#xe700;</text>
            <text class="__ag__upinfofollowtext__" v-if="item.score">{{
              a__ag__util__.numberReadable(
                id !== 0 ? item.score + 1 : item.score
              )
            }}</text>
          </div>
        </div>
      ...
      <div class="__ag__upinforight__">
        <text
          class="iconfont __ag__follow__"
          v-if="!id"
          @click="__ag_editFollow__"
          >&#xe66d;</text
        >
        <text
          class="iconfont __ag__follow__ isfollow-select_text"
          v-else
          @click="__ag_editFollow__"
          >&#xe700;</text
        >
    ...
    <div class="__ag__upinfobottom__" v-if="tab == 2">
      ...
      <div class="__ag__upinfo_operation__">
        <div
          class="__ag__upinfobottomlh__ __ag__upinfobottoma__"
          @click="__ag_black__"
        >
        ...
        <div
          class="__ag__upinfobottomlh__ __ag__upinfobottomb__"
          @click="__ag_report__"
        >
          <text class="iconfont __ag__iconlh__">&#xe6a0;</text>
    ...
    async __ag_editFollow__() {
      if (this.id) {
        try {
          ...
          if (e.message === "未登录") {
            await __ag__sport.__ag__infoUser_editGuest__(this)
            a__ag__util__.message("无法订阅")
            return
          }
        ...
        try {
          let resp = await __ag__sportApi__.editFollow({
