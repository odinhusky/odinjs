    ...
    <div class="__ag__video-content__" :style="{ display: isDisplay }">
      ...
      >
        <span
          v-if="isPlays"
          @click="clickPause"
          class="iconfont icon-pause __ag__play-icon__"
        ></span>
        <span
          v-else
          @click="clickStart"
          class="iconfont icon-play __ag__pause-icon__"
        ></span>
      </div>
      <div class="__ag__video-bar__">
        <div class="__ag__bar-lf__">
          ...
          <div class="__ag__danmu-item__" v-if="openDanmu">
            <span
              ...
              class="iconfont icon-chat-open __ag__danmu-icon__"
            ></span>
            <span
              v-else
              @click.stop="clickDanmu"
              class="iconfont icon-chat-close __ag__danmu-icon__"
            ></span>
        ...
        <div class="__ag__bar-rg__">
          <span
            ...
            class="iconfont icon-mute1 __ag__video-mutes__"
          ></span>
          <span
            v-else
            @click.stop="clickMute"
            class="iconfont icon-mute2 __ag__video-mutes__"
          ></span>
          ...
          <span
            ...
            class="iconfont icon-fullscreen1 __ag__video-fullscreen__"
          ></span>
          <span
            v-else
            @click.stop="exitFullscreen"
            class="iconfont icon-fullscreen-exit __ag__video-fullscreen__"
          ></span>
        </div>
      </div>
    </div>
...
.__ag__video-mute__ .__ag__triangle__ {
  ...
  border-bottom-color: @trans; /* 设置透明背景色 */
