    ...
    <div class="__ag__liveupitemimgview__">
      ...
      >
        <div class="__ag__lives__">
          <image
            :src="__ag__url__('static/a3/video1.png')"
            class="__ag__lives_video__"
          ></image>
        ...
        <div class="__ag__liveupitemtop__">
          ...
          <div class="__ag__liveupitemname__">
            <ag-userimg
              ...
              :avatar="item1.joinMap.user.avatar"
              :uid="item1.uid"
              :name="item1.joinMap.user.userNicename"
            ></ag-userimg>
            <text class="__ag__liveupitemuptext__">{{ item1.joinMap.user.userNicename }}</text>
          </div>
        </div>
