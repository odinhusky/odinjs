...
util.removeLeadingZeros = function(str) {
...
util.formatDate = function(date) {
  ...
  let formatDay = '';
    ...
    console.log('ar', ar, typeof ar[1])
    formatMonth = util.removeLeadingZeros(ar[1])
    formatDay = util.removeLeadingZeros(ar[2])
  ...
  formatMonth = util.removeLeadingZeros(month)
  formatDay = util.removeLeadingZeros(day)

	// const d = [year, month, day].map(util.formatNumber).join('-')
	console.log(month, day, formatMonth, formatDay)
	return `${formatMonth}月${formatDay}日`
}
