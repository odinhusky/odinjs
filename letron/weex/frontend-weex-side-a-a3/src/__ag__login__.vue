<template>
  <div class="__ag__login-main__">
    <ag-hbtitle :isLogin="true" :isback="true" :isBl="true"></ag-hbtitle>
    <div
      class="__ag__login-main-content__"
      :class="[ipx ? 'login-ipx' : '']"
    ...
    >
      ...
      <div class="__ag__login-service__" @click="service = !service">
        ...
        <text class="inline" @click.stop="__ag__goJump__(0)"
          >《用户隐私协议》</text
        >
        <text class="inline">和</text>
        <text class="inline" @click.stop="__ag__goJump__(1)"
          >《用户服务协议》</text
        >
      </div>
      ...
      <div class="__ag__login-regist__" v-if="pc == 'code'">
        <text class="__ag__login-regist_text__"
