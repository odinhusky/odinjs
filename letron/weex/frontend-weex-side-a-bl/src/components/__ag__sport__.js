...
sport.goPolicy = (t)=>{
	a__ag__util__.getPush('__ag__web__',{url: `https://${env.agreement}/privacy.html`,title:'Privacy'})
}
sport.goAgreement = (t)=>{
	a__ag__util__.getPush('__ag__web__',{url: `https://${env.agreement}/service.html`,title:'Service'})
}
