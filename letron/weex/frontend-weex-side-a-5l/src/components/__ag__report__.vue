    ...
    <div class="__ag__report__" v-if="isreport1">
        <div class="__ag__reporttab__">
            <div class="__ag__reporttitle__">
                ...
                <text class="__ag__reporttitletext__ iconfont" @click="onclose">&#xe64b;</text>
            </div>
            <div class="__ag__reportbody__">
                <div class="__ag__reportcontent__" v-for="(item,index) in reportList" @click="__ag__ontabreport__(index+1)" :key="'rt'+index">
                    ...
                    <text class="iconfont  __ag__resportcellonclass__ " v-if="tab ==index+1">&#xe682;</text>
    ...
    export default {
        ...
        methods:{
            ...
            __ag__onReport__(){
                ...
                __ag__sportApi__.editRoomReport({roomId:this.roomId,type:this.tab}).then(resp=>{
                    // this.$emit('onreport')
                    this.isreport1 = false
                    this.tab = 0
                     this.$emit('onclose')
                    ...
                    util.message(util.toStirng(res))
                })
			},
        }
    }
