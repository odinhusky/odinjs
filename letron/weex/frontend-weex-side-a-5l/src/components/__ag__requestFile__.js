...
function AgRequest(url, data={}, header={}){
	...
	if(!header['content-type']){
		header['content-type'] = 'multipart/form-data; boundary=----WebKitFormBoundarySX3SciE84x6MEWAC';
	}

	this.state = 0;
	let t = this;
	// let s =`file=${data.file}`
	let s  ='------WebKitFormBoundarySX3SciE84x6MEWAC'+'\r\n'+
	...
	// console.log('upload==',util.toStirng(header))
	...
	this.promise = new Promise((resolve, reject)=> {
		...
		stream.fetch({
			...
			console.log('r==1',util.toStirng(r))
