<template>
  ...
  >
    ...
    <ag-ipx
      :bg="
        env.brand == '5' ? '#07C160' : env.brand == 'bl' ? '#FCC400' : '#000000'
      "
    ></ag-ipx>
    ...
    <div class="__ag__anchorinfo_main__" v-if="!isFull">
      ...
      >
        ...
        <image :src="__ag__url__('static/Vector.png')" class="vector-img" />
        ...
        <div class="__ag__livegz__" v-if="item.id == 0">
          ...
          >
            ...
            <div class="luck-fk" @click="onLuckDraw" v-if="playStatus">
              <image
                class="fk-image"
                :src="__ag__url__('static/shijiebei/fka.png')"
              ></image>
    ...
    >
      <div class="index-modal">
        ...
        <image
          ...
          :src="__ag__url__('static/shijiebei/zhong.png')"
        ></image>
    ...
    calculateTime() {
      ...
      durationTimer = setInterval(() => {
        ...
        if (this.secondTime % 60 == 0) {
          ...
          if (this.info && this.info.joinMap && this.info.joinMap.live.id) {
            api
              .logView({ liveId: this.info.joinMap.live.id })
              .then((resp) => {})
          }
        }
...
.fk-text {
  ...
  letter-spacing: 2px;
  color: #ffffff;
  text-shadow: 0.5px 0.5px 0px #bd3141;
}
.__ag__lives_popup__ {
  width: 750px;
