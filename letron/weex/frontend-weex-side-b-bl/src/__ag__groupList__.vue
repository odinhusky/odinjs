    ...
    <div class="__ag__groups__" :class="[ipx ? '__ag__groups_ipx__' : '']">
        ...
        <div class="__ag__groups_content__">
            <div class="__ag__groups_list__" v-if="groupUsersList && groupUsersList.length">
                <div class="__ag__groups_item__" v-for="item in groupUsersLists" :key="item.id">
                ...
                <div class="__ag__groups_bottom__" v-if="groupUsersList && groupUsersList.length > 15">
                    <text class="__ag__bottom_text__" @click="__ag__onGroups__">查看更多群成员</text>
