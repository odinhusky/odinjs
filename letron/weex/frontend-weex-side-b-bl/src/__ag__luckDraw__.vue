<template>
  <div class="__ag__luck_main__">
    <image
      :src="__ag__url__('static/shijiebei/lbg.png')"
      class="__ag__bg_image__"
    />
    <scroller class="scroller" :show-scrollbar="false">
      <div class="__ag__luck_content__" :class="[ipx ? 'luck-ipx' : '']">
        ...
        <image
          :src="__ag__url__('static/shijiebei/title.png')"
          class="__ag__fl_image__"
        ></image>
        <div class="__ag__win_box__" v-if="resultList && resultList.length > 0">
          <image
            :src="__ag__url__('static/shijiebei/zjbg.png')"
          ...
          >
            ...
            >
              ...
              >
                ...
                <image
                  v-else
                  :src="__ag__url__('static/shijiebei/xxhg.png')"
                  class="turntable-image"
                ></image>
                <text
        ...
        <div class="__ag__luck_bottom__">
          ...
          <div class="__bot_btn_cen__" @click="onLuck">
            <image
              class="__btn_image__"
              :src="__ag__url__('static/shijiebei/cj-btn.png')"
            ></image>
          </div>
    ...
    >
      <image
        ...
        :src="__ag__url__(`static/shijiebei/${env.brand}-zs.png`)"
      ></image>
    </div>
    ...
    >
      <div class="luck-modal">
        ...
        <image
          ...
          :src="__ag__url__('static/shijiebei/nozj1.png')"
        ></image>

        <image
          v-if="!receive.awardId && this.luckNumber == 0"
          style="width: 422px; height: 412px"
          :src="__ag__url__('static/shijiebei/nozj2.png')"
        ></image>
    ...
    >
      <div class="luck-modal">
        ...
        <image
          ...
          :src="__ag__url__('static/shijiebei/jsrw.png')"
        ></image>
      ...
      <div class="luck-modal">
        <div class="logo-box" v-if="env.brand == '5'">
          <image
            ...
            :src="__ag__url__('static/shijiebei/5l3-logo.png')"
          ></image>
        </div>
        <image
          v-if="env.brand == 'bl'"
          style="width: 154px; height: 168px; margin-top: -30px"
          :src="__ag__url__('static/shijiebei/bl-zs.png')"
        ></image>
    ...
    async getPageAward() {
      try {
        ...
        for (let i = 1; i <= len; i++) {
          ...
          f.id = id
          f.name = "谢谢参与"
          f.logo = "../static/shijiebei/xxhg.png"
          list.unshift(f)
        }
        this.listAward = list
      } catch (error) {
...
.__ag__luck_turntable__ {
  width: 718px;
  margin-top: 26px;
  background-image: linear-gradient(to top, #a97f4d, #cbab58);
  border-radius: 40px;
  padding: 14px;
}
.__ag__luck_turntable_none__ {
...
.__ag__items_box__ {
  ...
  height: 203px;
  background-color: #fff;
  box-shadow: 0px 2.5px 0px #dcdcdc;
  border-radius: 16px;
  display: flex;
  flex-direction: column;
  align-items: center;
...
.box-btn {
  background-image: linear-gradient(to top, #ffe773, #ffbf56);
  box-shadow: 0px 7px 0px #b7631b;
  border-radius: 32px;
  justify-content: center;
}
.btn-text {
...
.active {
  ...
  box-shadow: 0px 2.5px 0px #ffe773;
}
.awardActive {
  background-color: #ffe773;
  box-shadow: 0px 2.5px 0px #ffe773;
