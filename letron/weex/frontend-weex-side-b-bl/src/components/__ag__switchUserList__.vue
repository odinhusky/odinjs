<template>
    <div class="__ag__switch_main__" v-if="list && list.length > 0" :style="switchstyle">
            ...
            <div class="__ag__anthor_item__" v-for="item in list" :key="item.id">
                <div class="__item_lf__">
                    <div class="__lf_avatar__">
                        <div class="__lf_avatar_item__">
                            <avator class="__ag__upimg__" :avatar="item.avatar" :islive="true" :name="item.upName"></avator>
                        </div>
                ...
                <div class="__item_rg__">
                    <div class="__rg_item__">
                        ...
                        <text class="__ag__uptext__">{{ item &&  item.joinMap && item.joinMap.room && item.joinMap.room.amount}}</text>
                    </div>
                    <div class="__rg_item__">
                        <text class="agiconfont  __ag__heart3__">&#xe700;</text>
                        <text class="__ag__uptext__">{{item && item.joinMap && item.joinMap.user &&  item.joinMap.user.score}}</text>
                    </div>
