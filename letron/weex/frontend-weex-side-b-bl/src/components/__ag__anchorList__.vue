<template>
    <waterfall class="__ag__anchorlist-main__" :show-scrollbar="false" column-count="1" column-width="auto" column-gap="0">
        ...
        <cell v-for="(item) in sortedStreamerList" :key="item.id" @click="__ag__clickTap__(item)" >
            <anchor-item class="__ag__anchor__" :isindex="isindex" :listFollowMap="a__ag__listFollowMap__" :item="item" @cancelFollow="__ag__cancelFollow__" @followTap="__ag__followTap__" @onClick="__ag__clickTap__(item)"></anchor-item>
        </cell>
