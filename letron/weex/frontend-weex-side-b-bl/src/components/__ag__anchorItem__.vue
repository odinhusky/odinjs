    ...
    <div class="__ag__anchorlist-item__" :class="[isindex?'__ag__index-anchor-item__':'']" v-if="item && item.id">
        <div v-if="isindex" class="__ag__anchorlist_box__">
            <div class="__ag__anchorlist-img__" >
                <div class="__ag__image_border__" :class="[item && item.joinMap && item.joinMap.live && item.joinMap.live.scheduleId ? '__ag__image_live_border__': '']">
        ...
        <div class="__ag__anchorlist_w__" v-else>
            <div class="__ag_w_lf__">
                ...
                <div class="__ag_w_c__">
                    <text class="__ag__anchorlist-text__ __ag__anchorlist_text__">{{item && item.userNicename}}</text>
                    <div class="__ag__anchorlist-score__ __ag__anchorlist_score__" v-if="showAction">
                        <text class="__ag__anchorlist-num__ __ag__anchorlist_num__">订阅人数:</text>
                        <text class="__ag__anchorlist-num__ __ag__anchorlist_num__">{{item &&  item.score}}</text>
                    </div>
                </div>
            </div>
            <div class="__ag_w_rg__">
                <div v-if="showAction" class="__ag__anchorlist_follow__">
                    <div class="__ag__anchorlist-gz__ __ag__anchorlist_item__ cancelfollow __ag__anchorlist_gz__" @click.stop="__ag__cancelFollow__(item)" v-if="isFollow">
                        <text class="__ag__anchorlist-dy__ heart3">已订阅</text> 
                    </div>
                    <div v-else class="__ag__anchorlist-gz__ __ag__anchorlist_item__ __ag__anchorlist_gz__" @click.stop="__ag__followTap__(item)">
                        <text class="__ag__anchorlist-dy__">订阅</text>
                    </div>
                    <div v-if="item && item.joinMap && item.joinMap.live && item.joinMap.live.scheduleId"  @click.stop="__ag__private__(item)">
                        <image resize="contain" :src="__ag__url__(`static/${env.brand}/${env.brand}-sliao.png`)" class="__ag__sliao__"/>
                    </div>
                </div>
            </div>
        </div>
