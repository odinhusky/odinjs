<template>
    <div class="__ag__confrontationlist__">
        ...
        <div class="__ag__conftitle__" v-for="(item,index) in recordList" :key="index">
            <text class="__ag__conftext__">{{util.dateFormat(item.beginTime)}}</text>
            ...
            <div class="__ag__confscore__" v-if="item.scorea!=item.scoreb">
                <text class="__ag__confscoretext__" v-if="item.teamNamea == teamName" 
                :class="[item.scorea < item.scoreb ? '__ag__shu__' : item.scorea > item.scoreb ? '__ag__ying__' :'']">{{item.scorea}}</text>
                <text v-else class="__ag__confscoreg__">{{item.scorea}}</text>
                <text class="__ag__confscoreg__">-</text>
                <text  v-if="item.teamNameb == teamName"  class="__ag__confscoretext__"
                :class="[item.scorea > item.scoreb ? '__ag__shu__' : item.scorea < item.scoreb ? '__ag__ying__' :'']">{{item.scoreb}}</text>
            ...
            <div v-else class="__ag__confscore__ ">
                <div class="__ag__confscorediv__ __ag__ping__">
                    <text class="__ag__confscoreg__ __ag__pingtext__">{{item.scorea}}</text>
                    <text class="__ag__confscoreg__ __ag__pingtext__">-</text>
                    <text class="__ag__confscoreg__ __ag__pingtext__">{{item.scoreb}}</text>
                </div>
            </div>
