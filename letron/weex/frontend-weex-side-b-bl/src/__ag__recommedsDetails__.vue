            ...
            <scroller class="__ag__recommeds-list" show-scrollbar="false"> 
                ...
                <div class="recommeds-details-middle">
                    ...
                    <div class="item-cell middle-cell">
                        <text class="__item-span middle-span">{{status[item.joinMap.sche.status]}}</text>
                        <text class="__item-span middle-span">{{forTypeDate(item.createTime)}} {{formatTime(item.createTime)}}</text>
                    </div>
                    <div class="middle-team">
                        <div class="__ag__match-team-a-text__">
                            <text class="__ag__match-team-teamName__ teama-teamName">{{item.joinMap && item.joinMap.sche && item.joinMap.sche.teamNamea}}</text>
                            <team-logo teamType="1" :teamFlag="item.joinMap && item.joinMap.sche && item.joinMap.sche.teamFlaga" :teamName="item.joinMap && item.joinMap.sche && item.joinMap.sche.teamNamea" class="__ag__team__"></team-logo>
				        </div>
                        <text class="vs-text">VS</text>
                        <div class="__ag__match-team-a-text__ __ag__match-team-b-text__">
                            <team-logo teamType="2" :teamFlag="item.joinMap && item.joinMap.sche && item.joinMap.sche.teamFlagb" :teamName="item.joinMap && item.joinMap.sche && item.joinMap.sche.teamNameb" class="__ag__team__"></team-logo>
                            <text class="__ag__match-team-teamName__ teamb-teamName">{{item.joinMap && item.joinMap.sche && item.joinMap.sche.teamNameb}}</text>
                        </div>
                    </div>
                </div>
