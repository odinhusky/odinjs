        ...
        <div class="__addFriend-content__">
            <div class="__add-item__">
                <div class="__add_item-img">
                    <image class="head-image" v-if="friendUser.avatar" :src="__ag__url__(friendUser.avatar)"></image>
                    <text class="item-text" v-else>{{charName(friendUser.userNicename)}}</text>
                </div>
