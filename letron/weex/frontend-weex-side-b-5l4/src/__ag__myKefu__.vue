	...
	<div class="__ag__kefu-main__">
		...
		<div class="__ag__kefu-contairner__" :class="[ipx?'kefu-ipx':'']">
			...
			<div class="__ag__kefu-textarea__">
				<textarea class="__ag__textarea__" v-model="a__ag__feedContent__" placeholder="请填写您遇到的问题及建议"></textarea>
			</div>
	...
	export default {
		...
		methods: {
			__ag__submit__() {
				...
				__ag__sport_api__.editFeedback({content:this.a__ag__feedContent__}).then(resp=>{
