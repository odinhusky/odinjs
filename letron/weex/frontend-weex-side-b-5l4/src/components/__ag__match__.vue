<template>
	<div class="__ag__matchmain__" >
		...
		<div class="__ag__sche-body__" :class="[ipx?'matchbody-ipx':'',ipx && loadinging?'matchbody-load-ipx':'',!ipx && loadinging?'matchbody-unload-ipx':'']">
			...
			<div class="__ag__schedule-bottom__" v-if="sliderIndex!=0" :class="[ipx?'schedule-bottom-ipx':'']" @click="__ag__onsliderIndex__"><text class="__ag__schedule-bottom-text__">回到今日赛程</text></div>
		</div>
	</div>
</template>
