<template>
    <div class="__ag__quality-main__" v-if="showQuality" :style="videoStyle" @click.stop="">
		...
		<div class="__ag__quality-content__">
			...
			<div class="quality-box" :class="[isFull?'full-box':'']">
				...
				<div class="quality-btn" :class="[isFull?'full-btn':'']">
					<div class="btn-q btn-b" @click.stop="close"><text class="qu-t">标清</text></div>
					<div class="btn-q btn-g" @click.stop="__ag__onLogin__"><text class="qu-t qu-s">高清</text></div>
