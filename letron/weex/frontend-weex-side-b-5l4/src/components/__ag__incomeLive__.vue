<template>
	<div class="__ag__incomelive__">
		<ag-uptime v-if="info.status<2" :info="info" :user="user" :list="sortedListMatchUser"></ag-uptime>
		<ag-enddatalive v-else :info="info" :list="sortedListMatchUser"></ag-enddatalive>
	</div>
</template>
