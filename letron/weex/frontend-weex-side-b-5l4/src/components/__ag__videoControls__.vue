        ...
        <div class="__controls-content__" :class="[isFullscreen?'full_content':'']">
            <div class="__controls-lf__">
                <div class="__controls-direct__"  v-if="!isFull">
                    ...
                    <text class="agiconfont __line-status__" v-else @click.stop="clickStart">&#xe66c;</text>
            ...
            <div class="__controls-rg__">
                ...
                <div class="__ag__dan_mu__" v-if="showDanmu">
                    <image class="__ag__danmu_image__" v-if="isDanmu" :src="__ag__url__('static/danmu-1.png')" mode="aspectFit" @click.stop="__ag_changeDanmu__('0')"></image>
