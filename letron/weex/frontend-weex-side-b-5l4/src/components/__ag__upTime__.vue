<template>
	<div class="__ag__uptime__" >
		<image class="__ag__uptimebackimg__" :src="__ag__url__(url)" ></image>
		<div class="__ag__uptimebkcolor__"></div>
		<div class="__ag__uptime_content__">
			<div class="__ag__uptimecontetn__" v-if="info && info.id" @swipe="handleSwipe">
				<div class="__ag__uptimesaishi__">
					...
					<div class="__ag__upteamdate__">
						...
						<text class="__ag__upteamdatetext__">{{formatDateTime(info.beginTime)}}</text>
					</div>
					<div class="__ag__uptimeteam__">
				...
				<div class="__ag__uporder__" v-if="info.status == 0 && !isAppoint" @click="onMakeAppointment">
					<text class=" agiconfont __ag__uporderappoint__">&#xe705;</text>
					<text class="__ag__upordertext__">预约</text>
				</div>
				<div class="__ag__uporder__ __ag__cg__" v-if="info.status == 0 && isAppoint"  @click="cancelAppointment">
					<text class=" agiconfont __ag__uporderappoint__">&#xe705;</text>
