<template>
	<div class="__ag__match-screen__">
		...
		<div class="__ag__screen-content__" v-if="!ishot">
			<div class="__ag__screen-body__" :class="[screen == 0?'__ag__select__': '']" @click="onscreen(0)">
				<text class="__ag__screen-body-text__" :class="[screen == 0?'__ag__select-status__': '']">赛事</text>
			</div>
			<div class="__ag__screen-body__" :class="[screen == 1?'__ag__select__': '']" @click="onscreen(1)">
