		...
		<div class="__ag__about-main-content__" :class="[ipx?'about-ipx':'']">
			<div class="__ag__about-item__">
				<div class="__ag__about-logo__">
					<!-- <image resize="contain" :src="__ag__url__('static/__ag__logo1__.png')" class="__ag__logo__"/> -->
					<image resize="contain" :src="__ag__url__(aboutLogo)" class="__ag__logo__"/>
					
				</div>
				<!-- <text class="__ag__about-title__">五楼直播</text> -->
