<template>
	<div class="__ag__newsitem__" @click="__ag__onnewsDetail__(isindex)">
		<div class="__ag__newsitemtitle__">
			<div class="__ag__newsmatch__"  v-if="item.joinMap &&item.joinMap.cls && item.joinMap.cls.name">
				<text class="__ag__newsmatchtext__">{{item.joinMap &&item.joinMap.cls && item.joinMap.cls.name}}</text>
			</div>
			<text v-if="item.joinMap &&item.joinMap.cls && item.joinMap.cls.name" class="__ag__newsitemtitletext__">	   {{item.title}}</text>
		...
		<div class="__ag__newsitemdate__">
			...
			<text class="__ag__newsitemtext__">{{__ag__formatToDate__(item.addTime)}}</text>
		</div>
	</div>
</template>
