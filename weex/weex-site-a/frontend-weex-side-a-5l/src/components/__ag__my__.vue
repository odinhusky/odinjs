<template>
	<div class="__ag__my__" :class="[ipx ? 'my-ipx' : '']" >
		...
		<ag-my-item title="我的关注" :isIcons="ag__isIcons__" @goJump="__ag__goJump__(3)" class="__ag__border__" v-if="isUser">
			<image  class="__ag__box_image__" :src="__ag__url__('/static/bl/gywm.png')"></image>
		</ag-my-item>
		<ag-my-item v-if="isUser" title="客服反馈" :isIcons="ag__isIcons__" @goJump="__ag__goJump__(0)" class="__ag__border__">
			<image  class="__ag__box_image__" :src="__ag__url__('/static/bl/kf.png')"></image>
		</ag-my-item>
		<ag-my-item title="设置" :isIcons="ag__isIcons__" @goJump="__ag__goJump__(1)" class="__ag__border__">
			<image  class="__ag__box_image__" :src="__ag__url__('/static/bl/sz.png')"></image>
		</ag-my-item>
		<ag-my-item title="关于我们" :isIcons="ag__isIcons__" @goJump="__ag__goJump__(2)" class="__ag__border__ __ag__border_last__">
			<image  class="__ag__box_image__" :src="__ag__url__('/static/bl/gywm.png')"></image>
		</ag-my-item>
