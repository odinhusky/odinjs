<template>
    <div class="__ag__richtext__">
        <div v-for="(item,index) in templateArr" :key="index" class="__ag__richbox__">
            <image v-if="item.src" :src="__ag__url__(item.src)" class="__ag__newdetails__image__"></image>
