...
const FiatDeal = () => {
  ...
  useEffect(() => {
    setAd(JSON.parse(localStorage.getItem("EditAd")!))
    setFixPrice(JSON.parse(localStorage.getItem("EditAd")!).price)
    setMinPrice(JSON.parse(localStorage.getItem("EditAd")!).orderLimitMin)
    setMaxPrice(JSON.parse(localStorage.getItem("EditAd")!).orderLimitMax)
    setDealAmount(JSON.parse(localStorage.getItem("EditAd")!).totalTradingAmount)
    setDeadTimePay(JSON.parse(localStorage.getItem("EditAd")!).paymentTimeLimit / (60 * 1000))
    if (JSON.parse(localStorage.getItem("EditAd")!).type === 1) {
      setDealStatus("sell")
    }
  }, [])
