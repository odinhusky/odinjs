      ...
      <PageContainer>
        ...
        <TopArea>
          ...
          < TopAreaRight>
            ...
            <ChangeAccountName>{t("resetGA")}</ChangeAccountName>
        ...
        <Inside>
          ...
          <SaveButton onClick={() => {
            if (!password) {
              ...
              setLoading(true)
              api.postData("/user/reset/google-auth", { password: password, mailCode: emailCode, phoneCode: kyc.phone ? phoneCode : null }).then(x => {
                setLoading(false)
                if (x.status !== 400) {
                  navigation(-1)
                  alert("重置成功")
            ...
            <SaveButtonWord>重置</SaveButtonWord>
          </SaveButton>
