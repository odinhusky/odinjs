      ...
      >
        ...
        >
          ...
          <p
            ...
            <p style={{ fontSize: 13, color: "#5F5C70", fontWeight: 600,fontFamily:"Open Sans" }}>
              {`${new Date(data.createdDate).getFullYear()}-${new Date(data.createdDate).getMonth() < 10 ? "0"+(new Date(data.createdDate).getMonth()+1) : new Date(data.createdDate).getMonth()+1}-${new Date(data.createdDate).getDate()}`}
            </p>
          </div>
        </div>
      </div>
