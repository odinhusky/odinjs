...
const AnnouncementModal: React.FC<{
  ...
  return (
    <>
      <HeaderContainer>
        <HeaderLeft>
          <LinkText to="/member" onClick={()=>{setNavSelectItem(false)}}>
      ...
      <ArticleContainer>
        <TitleContainer>
          ...
          <div style={{ display: "flex", marginTop: 16 }}>
            ...
            <TitleTextContainer>
              {/* <TitleText>{new Date(content.createdDate).toISOString().split("T")[0]}</TitleText> */}
              {/* <TitleText>{new Date(content.createdDate).toISOString().split("T")[1].slice(0,-5)}</TitleText> */}
            </TitleTextContainer>
          </div>
        </TitleContainer>
        <ArticleContent
