...
export const BaseModal = ({
  ...
  return (
    ...
    >
      <div
        className={`${classes.paper} ${classNameObj?.modalContainer}`}
      ...
      >
        ...
        >
          <Grid item>
            <div
              className={`
                ...
                ${classNameObj?.modalGridContainer}
              `}
            >
              <div className={`${classes.modalTitle} ${classNameObj?.modalTitle}`}>
                {title}
              </div>
              {
                isCloseIcon &&
...

          {
            subTitle &&
            <Grid item>
              <div className={`${classes.subTitle} ${classNameObj?.modalSubTitle}`}>
                {subTitle}
              </div>
            </Grid>
          }
