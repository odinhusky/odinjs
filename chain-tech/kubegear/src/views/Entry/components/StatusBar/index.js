...
export default function StatusBar() {
  ...
  const { asyncIsFileExist, useSelector } = useContext(GlobalContext);
  ...
  */
  const initData = async () => {
    try {
      ...
      const { start, end } = computeDayRange({ key: 'week' });
  ...
  */
  ...
  return (
    <section
      className={`
      ${classes.statusBar}
      ${(isShowGuide === true && currentStep === 1 && isSmallTablet === false) && classes.guideShow}
    `}
    >
      ...
      <section className={classes.statusSection}>
        ...
        <div className={classes.statusUnit}>
          <Typography
            ...
            variant="h6"
          >
            {`${t('running')}${t('enSpace')}${t('schedule')}`}
          </Typography>
        ...
        <div className={classes.statusUnit}>
          <Typography
            ...
            variant="h6"
          >
            {`${t('pending')}${t('enSpace')}${t('schedule')}`}
          </Typography>
        ...
        <div className={classes.statusUnit}>
          <Typography
            ...
            variant="h6"
          >
            {`${t('completed')}${t('enSpace')}${t('schedule')}`}
          </Typography>
