const glusterFSStyles = (theme) => {
// const glusterFSStyles = () => {
  ...
  return {
    ...
    createNativeVolumeModalWrapper: {
      display: 'flex',
      height: 300
    },
    createNativeVolumeModalVolume: {
      flex: 3,
      marginRight: 20,
      display: 'flex',
      flexDirection: 'column'
    },
    createNativeVolumeModalNoVolumeCanBind: {
      display: 'flex',
      height: '100%',
      justifyContent: 'center',
      alignItems: 'center'
    },
    createNativeVolumeModalVolumeDetail: {
      flex: 2,
      display: 'flex',
      flexDirection: 'column',
      justifyContent: 'space-between'
    },
    createNativeVolumeModalFormControl: {
      display: 'flex',
      borderRadius: 4,
      overflow: 'auto',
      flex: 1,
    ...
    modifyGlusterfsDetailModalInput: {
      width: 180
    },
    modifyGlusterfsDetailModalAddUserBar: {
      display: 'flex',
      alignItems: 'stretch',
      '& > :first-child': {
        flex: 2,
    ...
    modifyGlusterfsDetailModalUserBox: {
      margin: '20px 0',
      border: `1px solid ${theme.palette.customColor.black_87}`,
      height: 200,
      overflow: 'auto'
    },
    modifyGlusterfsDetailModalUserBoxItem: {
      padding: 16,
    ...
    modifyGlusterfsDetailModalName: {
      width: 100,
      overflow: 'hidden',
...
export default glusterFSStyles