...
/**
 * @author odin
 * @level views/Hardware/ImagePage
 * @component ImagePage
    ...
    <>
      {
        isDeleting
          ...
          <>
            ...
            />
            <div className={`${classes.hardWareImagePageTopBar}`}>
              <div className={`${classes.hardWareImagePageLeft}`}>
                <MuiDropdown
              ...
              <div className={`${classes.hardWareImagePageRight}`}>
                <MuiAutocomplete
                  disabled={isDataLoading}
