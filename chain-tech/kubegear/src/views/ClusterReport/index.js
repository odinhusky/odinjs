...
function ClusterReport() {
  ...
  return (
    <ClusterReportContext.Provider value={context}>
      <div className={`${classes.clusterReportContainer}`}>
        <BreadCrumbs />
        <Toolbar
        ...
        <div
          className={`
            ${classes.clusterReportWrapper}
            ${activeTab === 'usedTime' ? `${classes.overflowHidden}` : ''}
          `}
        >
          {
            activeTab === 'cluster' &&
