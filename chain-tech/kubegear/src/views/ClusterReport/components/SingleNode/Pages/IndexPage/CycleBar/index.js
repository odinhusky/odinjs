...
/**
 * @author odin
 * @level views/ClusterReport/SingleNode/SingleNodeTab/CycleBar
 * @component CycleBar
 * @description CycleBar
*/
const CycleBar = ({
  setCycle,
  totalHost,
  ...
  return (
    <div className={`${classes.flex_align_center} ${classes.flex_wrap}`}>
      <MuiDropdown
        classes={{ root: `${classes.mr_10} ${classes.mb_20} ${classes.defaultInput}` }}
        list={totalHost}
        maxWidth={150}
        onChange={(e) => {
      ...
      />
      {
        selectedKey === 'custom' &&
          <>
            <div className={`${classes.defaultInput} ${classes.mr_10} ${classes.mb_20}`}>
