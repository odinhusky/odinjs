...
/**
 * @author odin
 * @level views/VirtualGroup/UserSettingModal
 * @component UserSettingModal
 * @description UserSettingModal container to edit this cluster distribution data
*/
  ...
  const getData = (vg) => {
    getVgLimitResource(vg)
      .then((data) => {
        ...
        const resources = Object.entries(resourceCells)
          .map(([key, value]) => (
