...
- `pnpm exec storybook@latest automigrate --config-dir apps/mobile/.storybook --renderer @storybook/react`

- `pnpm exec storybook@latest automigrate --config-dir libs/mobile/shared/ui/.storybook --renderer @storybook/react`
