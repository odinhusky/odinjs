...
const MyButton = ({
  ...
  return (
    <button
      className={`relative group cursor-pointer flex justify-center items-center text-sm text-white linear-2-button font-extrabold ${className}`}
      onClick={onClick}
    >
      {children}
    </button>
...
export const MyPage = ({ userVIPInfo, currentLevel }: IMyPageProps) => {
  ...
  return (
    <PageContainer className="bg-[var(--grayscale-25)]">
      <div className="relative overflow-y-scroll text-white pb-4 max-w-[447px] m-auto">
        {/*通知Icon*/}
        {/* <div
        ...
        <div className="p-4 rounded-2xl bg-[var(--grayscale-20)] mt-2">
          ...
          {damaResult.isShowDama ? (
            <div
              className="mt-3" /**p-4 rounded-2xl bg-[var(--grayscale-20)]  */
            >
              <div className="flex justify-between items-center text-sm font-bold">
        ...
        <div className="p-4 rounded-2xl bg-[var(--grayscale-20)] mt-2">
          ...
          <button
            className="w-full h-10 flex items-center justify-center rounded-[100px] border-[1.5px] border-[var(--white-70)] text-[var(--white-70)]"
            onClick={() =>
