...
export const WithdrawPanelTerms = ({}: WithdrawPanelTermsProps) => {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <WalletContent className={cx(FLEX_CENTER, 'gap-5')}>
        <div>
        ...
        <BaseBtn
          btnClass={cx(
            'border-popup-button btn-todos-main w-[82px] h-7 border-none rounded-[4px] before:rounded-[4px]',
            FLEX_CENTER
          )}
          childrenClass={cx('text-xs leading-6 text-white font-medium')}
          children={'Cheque'}
