...
import U9AppCarousel from './U9AppCarousel';
import { IndexTabs } from './IndexTabs';
import { CellGameItem } from '../../../../components-bs/GameTypeSection/env/u6/CellGameItem';
import cx from '../../../../utils/cx';
import useU9IndexPageBase from '../../hooks/useU9IndexPageBase';
import U9IndexGameTabs from './U9IndexGameTabs';
import U9Announcement from './U9Announcement';

type U9IndexPageProps = {
...
export const U9IndexPage = (props: U9IndexPageProps) => {
  const {
    setViewType,
    gameList,
  ...
  const { indexBannersList, indexGameTabs } = useU9IndexPageBase();
  ...
  return (
    <PageContainer id={'index-page'} className="pb-10 mb-0 tablet:pt-2.5">
      ...
      >
        <U9AppCarousel indexBannersList={indexBannersList} />
      </div>
      ...
      {/* 遊戲選項 */}
      <U9IndexGameTabs indexGameTabs={indexGameTabs} />
