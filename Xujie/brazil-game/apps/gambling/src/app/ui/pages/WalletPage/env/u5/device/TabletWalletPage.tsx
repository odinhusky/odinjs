  ...
  return (
    <div className='text-white pb-[100px]'>
      ...
      <div
        className='relative'
      >
        <div className='relative flex overflow-hidden gap-4' ref={scrollWrapperRef}>
          <BalanceCard
            className='flex-shrink-0 w-4/5 brightness-50'
      ...
      {damaResult.isShowDama && (
        <div className="flex flex-col gap-2 mt-5 mx-8">
...
export default TabletWalletPage
