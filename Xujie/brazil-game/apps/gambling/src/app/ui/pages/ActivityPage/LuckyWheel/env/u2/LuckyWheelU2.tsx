...
interface LuckyWheelU2Props {

}

export const LuckyWheelU2 = ({
  ...
  const luckyWheelLineContainerClass = cx(
    ...
    'flex',
    'text-sm leading-5',
    'tablet:text-lg tabletlet:leading-7',
  );
      ...
      <div className={cx(
        ...
        <div className={cx(
          ...
          <LuckyWheelLineContainer
            ...
            btnClass={cx(btnClass, 'min-w-[103px] tab:min-w-[135px]')}
            onClick={() => {
