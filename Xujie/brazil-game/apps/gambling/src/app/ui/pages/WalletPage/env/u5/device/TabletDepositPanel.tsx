...
const TabletDepositPanel = ({
  ...
  return (
    <div className="text-white p-8 rounded-lg bg-[var(--grayscale-20)] mt-6">
      ...
      <div className="flex justify-center mt-8">
        <button
          ...
          className={cx(
            'linear-5-button',
            'min-w-[312px] rounded-full text-white py-3 font-extrabold'
          )}
        >
          Depósito
        </button>
...
export default TabletDepositPanel;
