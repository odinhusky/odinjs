...
export const HowToImage = (props: any) => {
  ...
  return !isInvitationOpen
    ...
    : (<HowToImageContainer className={props.className}>
      <img className="hidden sm:block w-max-[100%] h-auto"
           src={`assets/${environment.uVersion}/topTitle1.ed9276b2.png`}/>
      ...
      <img className={"mb-2 hidden sm:block w-max-[100%] h-auto"}
           src={`assets/${environment.uVersion}/topTitle2.396e135e.png`}/>
      ...
      <div className={"text-center"}>
        <div className={"text-[#ffd624] mb-3"}>Partilhar ligações através de software social</div>
        <img className={cx(
          'w-full',
          isMobile ? 'h-8' : 'h-10'
