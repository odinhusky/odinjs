...
import { CAROUSEL_TRANSITION_DURATION } from 'apps/gambling/src/assets/constant/time';
...
export const U9AppCarousel = (props: IAppCarousel) => {
  const { isMobile } = useBreakpoint();
  const TransitionDuration = CAROUSEL_TRANSITION_DURATION;
