		...
		<PageContainer>
			...
			<section>
				<div className={cx(
					...
					<div
						className={cx(
							{ 'text-[56px] font-black pl-16 w-3/4': isDesktop },
				...
				<BoxContainer>
					...
					<div
						...
						<div
							...
							<div className={cx('w-full mb-1 text-sm mobile:text-base tablet:text-lg font-medium')}>Perdas de ontem</div>
							<div
								className={cx('w-full text-lg tablet:text-xl font-medium text-[var(--state-error-main)]')}>{yesterdayLoss}</div>
						</div>
								...
								<div>
									{
										tableBody.length ? <>
											{tableBody.map((record: any, i) => (
												<div key={i}
													className={"w-full mb-3 last:mb-0 text-white"}
												>
													...
													{record.subs.map((item: any, index: number) =>
														<div className='mt-1'>
