  ...
  return (
    <div className={"p-5 md:p-10 md:pt-0 w-full"}>
      <div
        ...
        <div
          className={cx("text-base text-main-state-warning leading-none mb-4 mt-2", {'md:text-4xl md:text-bold md:mb-14': !isMobile})}>
        ...
        <section className={cx("flex flex-col w-full", {"md:flex-row": !isMobile})}>
          <section className={cx("mr-10 w-full", {"md:w-[60%]": !isMobile})}>
            <ShadowContainer
              className={cx("flex flex-row justify-between p-4 mb-3 text-sm bg-varient", {"md:text-lg md:mb-5 md:p-5": !isMobile})}>
            ...
            {!isMobile && (<ShadowContainer
                className={cx("flex flex-col justify-between p-4 mb-4 bg-varient", {"md:text-lg md:mb-5 md:p-5": !isMobile})}>
                ...
                <ButtonPro className="w-1/2 whitespace-nowrap" type="blue" size="medium" onClick={onClickToCopy}>Copiar
                  código de pix</ButtonPro>
              </ShadowContainer>
            )}
          ...
          {!isMobile && (
            <section className={cx("w-full mb-4 ", {"md:w-[40%]": !isMobile})}>
              <ShadowContainer className={"flex flex-col justify-between items-center h-full bg-varient"}>
                <div
                  className={"text-white font-bold w-full rounded-xl text-4xl py-4 bg-gradient-to-b from-[var(--btn-gradient1-from)] to-[var(--btn-gradient1-to)]"}>R${amount}</div>
                <div className="h-full flex justify-center items-center">
                  <QRCode className={cx("w-[80%] min-w-[100px] max-w-[280px] mb-5",)}
          ...
          {isMobile && (
            <ShadowContainer
              className={"flex flex-col justify-between items-center h-full px-4 py-5 text-center bg-varient"}>
              ...
              <ButtonPro className="whitespace-nowrap !px-4" type="green" size="small" onClick={onClickToCopy}>Copiar
                código de pix</ButtonPro>
            </ShadowContainer>
          )}
