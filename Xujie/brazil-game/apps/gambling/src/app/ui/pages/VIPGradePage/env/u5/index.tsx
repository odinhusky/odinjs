...
const VIPGradePage = (props: IVIPGradePageProps) => {
  ...
  const allLevelInfoWithBonus = props.allLevelInfo.map((info) => {
    ...
    return {
      ...
      upRewardAmount: info.level < 20 ? `R$ ${formatLocaleMoney(info.upRewardAmout / 100)}`: `Nível Mega Jackpot:${jackpotMap[info.level.toString()]} Ou numerário de valor equivalente`,
