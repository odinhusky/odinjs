                ...
                <BoxContainer>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div className={cx('w-full')}>Perdas de ontem</div>
                            <div
                                className={cx('w-full text-[var(--state-error-main)]')}>{yesterdayLoss}</div>
                        </div>
                    ...
                    <div className="overflow-x-auto text-[var(--grayscale-100)] text-center rounded-xl mt-4">
                        <table className="w-full">
                            <thead
                                className={cx('bg-linear-4-disabled')}>
                            <tr>
