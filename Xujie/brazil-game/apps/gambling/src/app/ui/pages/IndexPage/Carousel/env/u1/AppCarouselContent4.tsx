  ...
  return (
    ...
    >
      <div className={""}>
        ...
        {/*{isMobile ? (*/}
        {/*  <CarouselImage alt={"h5_banner_4"}*/}
        {/*                 src={`assets/${environment.uVersion}/${environment.mvVersion}/banner_vip_m.png`}/>*/}
        {/*) : (*/}
        {/*  <CarouselImage alt={"banner_4"} src={`assets/${environment.uVersion}/${environment.mvVersion}/banner_vip.png`}/>*/}
        {/*)}*/}
      </div>
    </CarouselContainer>
  )
