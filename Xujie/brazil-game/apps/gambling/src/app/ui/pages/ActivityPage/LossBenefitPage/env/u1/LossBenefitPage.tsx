...
export const LossBenefitPage = (props: ILossBenefitPage) => {
    ...
    const activityLossBenefitTitle = "Benefício de alívio de perdas";
    ...
    return (
        <PageContainer>
            ...
            <BackNavigation
                title={isMobile &&
                    <div className={"w-full text-center font-bold"}>{activityLossBenefitTitle}</div>}
                onClick={() => {
