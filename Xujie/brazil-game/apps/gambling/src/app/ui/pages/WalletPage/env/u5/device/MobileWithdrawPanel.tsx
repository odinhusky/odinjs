...
const MobileWithdrawPanel = ({
  ...
  return (
    <div className="text-white mt-4">
      {contextHolder}
      <div className="p-4 rounded-lg bg-[var(--grayscale-20)]">
        <Input
        ...
        <div className="text-[var(--grayscale-70)] text-sm -mt-3">
      ...
      <div className="mt-4 p-4 rounded-lg bg-[var(--grayscale-20)] text-sm">
        <div className="text-center text-base font-extrabold">
          Regras de Retirada
        </div>

        <div className="flex flex-col justify-center items-center rounded-lg bg-[var(--grayscale-10)] py-3 px-5 mt-5 gap-3">
          ...
          <button
            ...
            className="linear-5-button min-w-[200px] py-[10px] text-sm font-extrabold rounded-full "
          >
            Cheque
          </button>
        </div>
        <div className="rounded-lg bg-[var(--grayscale-10)] py-3 px-5 mt-2 text-center">
...
export default MobileWithdrawPanel;
