...
const DesktopWithdrawPanel = ({
  ...
  if (isDuringRestrictTime) {
    return (
      <div className="p-8 rounded-lg bg-[var(--grayscale-20)] text-white mt-8">
        <div className="text-center text-lg font-extrabold">
          A conta está sendo liquidada
        </div>
    ...
    <div className="text-white mt-8">
      ...
      <div className="p-8 rounded-lg bg-[var(--grayscale-20)]">
        <Input
          ...
          type="text"
          inputmode="numeric"
          inputClassName="text-base placeholder:text-[var(--grayscale-60)] text-white"
          themeStyle={'normal'}
        ...
        <WithdrawForm
          ...
          inputClassName="text-base placeholder:text-[var(--grayscale-60)] text-white"
          metaInputClassName="hover:text-white"
          errorMessageClassName="text-[var(--state-error-main)]"
        />
        ...
        <div className="mt-8 flex justify-center">
          <button
            ...
            className="linear-5-button py-3 min-w-[480px] text-base font-extrabold rounded-full"
          >
            Retirar
          </button>
        </div>
      ...
      <div className="mt-16 p-8 rounded-lg bg-[var(--grayscale-20)]">
        <div className="text-center text-lg font-extrabold">
          Regras de Retirada
        </div>
...
export default DesktopWithdrawPanel;
