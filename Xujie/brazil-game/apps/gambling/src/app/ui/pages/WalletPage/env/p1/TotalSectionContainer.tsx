...
const StyledTotalSectionContainer = styled.div`
  ...
  background: var(
    --background-dashboard-main,
    linear-gradient(
      180deg,
      var(--background-dashboard-main-from) 0%,
      var(--background-dashboard-main-via) 85.42%,
    ...
    >
      ...
      >
        ...
        <div className={'w-full flex-[2] flex flex-row '}>
          <div className={'flex-1 flex flex-col justify-center items-center'}>
            ...
            <div
              className={cx(
                'flex flex-col text-sm md:text-xl mt-3 md:mt-4 text-white font-noraml'
              )}
            >
              Balanço Total
            </div>
      ...
      {isMobile && (
        <TotalSectionBottomContent
          className={
            ' flex flex-row flex-wrap justify-between items-center text-base md:text-medium text-[var(--secondary-assistant)]'
          }
        >
      ...
      {!isMobile && (
        <TotalSectionBottomContent
          className={
            ' flex flex-row flex-wrap justify-between items-center text-base text-[var(--secondary-assistant)] p-3'
          }
        >
          <TotalDetailItem
            titleText={
