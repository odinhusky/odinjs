...
import { WebsiteLogo } from '../../../header/env/p1/components/WebsiteLogo';
      ...
      {renderByRWD(
        {
            ...
            <div>
              {
                <div
                  className={cx(
                    'text-[var(--white)] px-4 pt-8 pb-[80px] text-xs bg-[var(--main)]'
                  )}
                >
                  <div className="w-full flex gap-20">
                    ...
                    >
                      <div className="text-white text-sm font-bold w-full">
                        Jogo
                      </div>
                    ...
                    >
                      <div className="text-white font-bold text-sm w-full">
                        Ajuda
                      </div>
                      <div className="h-[1px] w-full bg-gradient-to-r from-transparent via-white to-transparent" />
                      <button
                  ...
                  <section className="mt-3">
                    <div className={'flex gap-3 items-center mb-2'}>
                      <WebsiteLogo className="w-[96px] h-[48px]" />
          ...
          tablet: (
            <div className="bg-[var(--main)] text-[var(--white)] pt-8 px-8">
              <div className={'flex gap-4 w-full'}>
                ...
                >
                  <div className="text-white font-bold pb-3 text-sm w-full">
                    Ajuda
                  </div>
                  <div className="h-[1px] w-full bg-gradient-to-r from-transparent via-white to-transparent" />
                  <button
          ...
          desktop: (
            <div>
              {
                <div className="bg-[var(--main)] text-[var(--white)] pt-10 px-12">
                  ...
                  <div className="flex-col flex items-center">
                    <div className="mt-5 w-1/2 grid grid-cols-7 gap-5">
                      <LazyCacheImage
                        alt="footer1"
                        src={`assets/shared/footer-18+.png`}
                      />
                      ...
                      <LazyCacheImage
                        ...
                        src={`assets/shared/footer-skrill.png`}
                        onClick={() =>
                          window.open('https://www.skrill.com/pt/')
                        }
                      />
                      <LazyCacheImage
                        alt="footer1"
                      ...
                      <LazyCacheImage
                        ...
                        src={`assets/shared/footer-interac.png`}
                        onClick={() =>
                          window.open('https://www.interac.ca/en/')
                        }
                      />
                      <LazyCacheImage
                        alt="footer1"
                        src={`assets/shared/footer-gamCare.png`}
                        onClick={() =>
                          window.open('https://www.gamcare.org.uk/')
                        }
                      />
                      <LazyCacheImage
                        alt="footer1"
