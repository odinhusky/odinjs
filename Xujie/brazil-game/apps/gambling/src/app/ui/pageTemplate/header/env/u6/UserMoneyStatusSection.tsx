    ...
    return (
        <div
            className={cx('flex flex-row justify-between items-center',
                ...
                'mobile:h-10 mobile:px-4 mobile:gap-3 mobile:text-base',
                'tablet:h-10 tablet:px-5 tablet:gap-3 tablet:text-xl',
                props.className)}>
            <button
            ...
            <div
                ...
                {isUserMoneyStatusLoading ?
                    <ThreeDots width={80} height={20} className={'w-4'}/> : `R$ ${formatLocaleMoney(totalBalanceSheetValue)}`
                }
            </div>
            {/*{*/}
            ...
            <button
                ...
                <CacheImage
                    ...
                    alt={'add'}
                    src={`assets/${environment.uVersion}/ic_add.png`}/>
            </button>
        </div>
    )
}
