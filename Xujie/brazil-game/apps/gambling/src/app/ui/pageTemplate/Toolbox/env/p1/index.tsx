            ...
            {mobileShowDownload && (
              <div className={"mb-2"}>
                <ToolButton isMobile={isMobile} className={""} onClick={props.onClickToDownload}>
                  <img alt={"download"} className="w-[40px] md:w-[80px]" src={`assets/${environment.uVersion}/icon-download.png`}/>
                </ToolButton>
              </div>
            )}
            {
              mobileShowCustomerService && (
                <div>
                  <ToolButton isMobile={isMobile} className={""} onClick={() => {
                    ...
                    <img alt={"telegram"} className="w-[40px] md:w-[80px]" src={`assets/${environment.uVersion}/customer-service-2.png`} />
                  </ToolButton>
                </div>
              )
            }
