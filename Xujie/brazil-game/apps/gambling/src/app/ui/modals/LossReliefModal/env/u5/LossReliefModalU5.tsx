...
interface LossReliefModalU5Props {
  onClose: () => void;
  onConfirm: () => void;
  isOpen?: boolean;
}

export const LossReliefModalU5 = ({onClose, onConfirm}: LossReliefModalU5Props) => {
  ...
  return (
    ...
    >
      <div className={cx(
        ...
        'tab:w-[532px] tab:h-[458px]',
        'desk:w-[699px] desk:h-[610px]',
        'relative',
        {
          'desk:w-[480px] desk:h-[548px]': screenHeight <= 610
        }
      )}>
        {/* 右上角關閉按鈕 */}
        <button
        ...
        <button 
          className={cx(
            ...
            'absolute', X_CENTER, '-bottom-[9%] tab:-bottom-[7%] desk:-bottom-[6%]'
          )}
...
export default LossReliefModalU5;
