...
interface DailyCashBackModalU1Props {
  onClose: () => void;
  onConfirm: () => void;
  isOpen?: boolean;
}

export const DailyCashBackModalU1 = ({
  onClose,
  onConfirm,
  isOpen,
}: DailyCashBackModalU1Props) => {
...
export default DailyCashBackModalU1;
