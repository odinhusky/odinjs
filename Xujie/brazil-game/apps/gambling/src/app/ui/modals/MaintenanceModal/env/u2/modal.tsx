...
export const RiojungleMaintenanceModal = (props: IMaintenanceModal) => {
  ...
  return (
    <BaseModal>
      <div
        className={cx(
          'flex flex-col fixed bg-gradient-144 from-[var(--liner-main-from)] to-[var(--liner-main-to)] rounded-lg py-6',
          {
      ...
      >
        <div
          className={cx('self-center', {
            'w-[320px] h-[300px] my-5 ': isDesktop,
