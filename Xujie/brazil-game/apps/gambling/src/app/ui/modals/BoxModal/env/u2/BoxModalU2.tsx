...
interface BoxModalU2Props {
  onClose: () => void;
  onConfirm: () => void;
  isOpen?: boolean;
}

export const BoxModalU2 = ({ onClose, onConfirm, isOpen }: BoxModalU2Props) => {
      ...
      >
        ...
        <button
          className={cx(
            ...
            'absolute',
            X_CENTER,
            'bottom-[12%] tab:bottom-[10%] desk:bottom-[10%]',
            FLEX_CENTER,
            'text-sm leading-5',
