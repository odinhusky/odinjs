  ...
  return (
    <BaseModal
      ...
      <div className={cx(`
        ...
        bg-gradient-to-b from-[var(--main-primary-varient)] to-[var(--main-primary-varient)]
      `,
        'border-solid border-[1px] border-[var(--primary-assistant)]',
        ...
        <ListItem className={'text-white mb-2'}
                  ...
                  isEnd={true}
        />
        <div className="text-[var(--white)] text-sm leading-5 text-center mb-2">Para cooperação comercial, entre em contato com o gerente</div>
