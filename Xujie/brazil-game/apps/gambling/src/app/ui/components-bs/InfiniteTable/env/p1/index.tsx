  ...
  return (
    ...
    >
      <thead
        className={
          cx(
            'flex bg-[var(--table-main)] justify-between',
            headerClassName
          )
        }
      >
          ...
          <th
            ...
            className={
              cx(
                ...
                'py-[10px] font-bold w-full flex justify-center items-center',
      ...
      }
      {
        datasource.length === 0 && showNoData && (
          ...
          >
            ...
            <div
              className='font-normal text-xs w-full text-center text-[var(--main-secondary-main)]'
            >
              Nada aqui
            </div>
          </div>
