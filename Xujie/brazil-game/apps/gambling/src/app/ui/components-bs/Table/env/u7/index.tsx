	...
	return (
		<>
			<div className={cx('h-full w-full flex flex-col text-white', props?.containerClassName)}>
				<div className={cx("h-14 overflow-hidden rounded-lg", props?.theadBoxClassName)}>
					...
					<table className={cx('relative table w-full table-fixed h-full', props?.tableClassName)}>
						<tbody className={cx("")}>
							{dataSource.length === 0 ? <tr>
								<NoData className="w-full !py-4" imgClassName="!w-[120px] !h-[120px] mobile:!w-40 mobile:!h-40 tablet:!w-50 tablet:!h-50" textClassName="!text-base mobile:!text-lg font-bold" />
							</tr> :
