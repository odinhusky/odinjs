...
export const GameTypeSectionWithPagination = (
  ...
  const showItems: LeaderGameItem[] = [
    {
  ...
  // 需求修改，不分頁顯示
  // Reset Pagination when type change
  // useEffect(() => {
  //   goToPage(1);
  // }, [gameTypeName])
  ...
  return (
    <section
      className={cx({
        'flex flex-col mb-4 mt-4 lg:mt-5': !props.isLatestItem,
      })}
    >
