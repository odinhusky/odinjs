...
export interface WalletPageWithdrawContentStoreTypes {
  ...
  withdrawBankCards: SavedBankListResult[];
  setWithdrawBankCards: (bankCards: SavedBankListResult[]) => void;
  withdrawBankValue: SavedBankListResult | null;
  setWithdrawBankValue: (bankCard: SavedBankListResult | null) => void;
  disabled: boolean;
  ...
  create<WalletPageWithdrawContentStoreTypes>()(
    devtoolsAndPersistWrapper(
      ...
      (set) => ({
        ...
        withdrawBankValue: null as SavedBankListResult | null,
        setWithdrawBankValue: (bankCard) =>
          set(() => ({ withdrawBankValue: bankCard })),
        withdrawBankCards: [] as SavedBankListResult[],
        setWithdrawBankCards: (bankCards) =>
          set(() => ({ withdrawBankCards: bankCards })),
        disabled: false,
