...
const InviteTaskRulesContent = () => {
  ...
  const columns: ITableColumn<InviteTeamRewardRuleItemResult>[] = [
    ...
    },
    {
      ...
      render: (record) => formatMoney(record.commission),
    },
  ];
  return (
    <div
    ...
    >
        ...
        return (
          <div key={index}>
            <div className="relative">
              ...
              <div
                className={cx(
                  'text-lg bgi-text-[var(--grayscale-100)] font-semibold text-center',
                  'drop-shadow-[0px_2px_2px_#33333340] text-nowrap',
                  'absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2'
                )}
              >
                {renderI18N({ i18nKey: data.title }, t)}
              </div>
            </div>
            <div
              className="bgi-border-[var(--base-2-light)]
                  text-sm font-medium
                  bgi-text-[var(--grayscale-100)] bgi-[var(--linear-1)]
                  rounded-lg after:rounded-lg after:border-1
                  mx-[3%] p-3 m-3"
            >
      ...
      <div>
        ...
        <div
          className="bgi-[var(--linear-1)] rounded-lg mx-[3%] mt-3
            bgi-border-[var(--base-1-light)] after:rounded-lg"
        >
          <Table
            classNames={{
              thead:
