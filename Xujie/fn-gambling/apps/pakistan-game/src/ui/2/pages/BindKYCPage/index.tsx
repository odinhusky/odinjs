...
import { KYCValidator } from '@/validator/antdValidator';
...
export const BindKYCPage = () => {
  ...
  const updateFormValues = useKycDisplayStore(
      ...
      >
        ...
        >
          ...
          <BindKYCBankAccount
            ...
            validator={{
              username: (value) => KYCValidator.username(value, t),
              walletAccount: (value) => KYCValidator.walletAccount(value, t),
              bankAccountNumber: (value) =>
                KYCValidator.bankAccountNumber(value, t),
              cnicCode: (value) => KYCValidator.cnicCode(value, t),
              password: (value) => KYCValidator.password(value, t),
              bankName: (value) => KYCValidator.bankName(value, t),
            }}
          />
