  ...
  },
  {
    ...
    detail: (
      <div className="text-[var(--grayscale-100)] text-sm font-medium p-2">
        ...
        <div>
          🙌 - Level up rewards{' '}
          <span className="text-[#FFE100]">20 PKR-30000 PKR</span>!
        </div>
        <div>
          🙌 - Monthly rewards{' '}
          <span className="text-[#FFE100]">30 PKR-99999 PKR</span>!
        </div>
      </div>
    ),
  },
...
const payLogoList = [
  {
    logo: 'pop/logo_easypaisa',
    text: 'EasyPaisa',
  },
  {
    logo: 'pop/logo_jazzcash',
    text: 'JazzCash',
  },
  {
    logo: 'pop/logo_onlinebanking',
    text: 'Online Banking',
  },
];
const PopPage = () => {
  ...
  return (
    <div className="bgi-[var(--bg-main)]">
      <div
        className={cx(
          widthClass,
          'bgi-[var(--grayscale-10)] mobile:pb-[17vh] pb-[15vh]'
        )}
      >
        ...
        <div className="px-3.5 flex flex-col gap-3">
          {smList.map((item) => (
            <div key={item.img}>
              <div className="p-0.5 bg-[var(--grayscale-20)] rounded-lg">
                <img
        ...
        <div className="flex bg-[var(--grayscale-00)] gap-2 py-1 justify-center my-4">
          {payLogoList.map((item) => (
            <div key={item.logo} className="flex items-center gap-0.5">
              <img
                className="h-6"
                src={getImgUrl(EResourceLevel.V, item.logo)}
                alt="pay_logo"
              />
