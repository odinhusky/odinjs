        ...
        <footer className="flex flex-col gap-1 justify-center items-center py-[3vh]">
          <div
            className="grid grid-cols-2
                tablet:py-12 tablet:px-8 mobile:py-8 mobile:px-6 py-6 px-4
                tablet:gap-8 gap-6 justify-center"
          >
            <img
              src={getImgUrl(
                EResourceLevel.V,
                'officialWeb/footer/logo_easypaisa'
              )}
              alt="Easypaisa"
              className="img-fluid max-w-[360px] w-full"
            />
            <img
              src={getImgUrl(
                EResourceLevel.V,
                'officialWeb/footer/logo_jazzcash'
              )}
              alt="Jazzcash"
              className="img-fluid max-w-[360px] w-full"
            />
