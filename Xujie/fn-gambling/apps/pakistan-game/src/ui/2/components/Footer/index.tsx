    ...
    return isDisplayFooter ? (
      ...
      >
        ...
        >
          <div
            className={cx(
              'flex flex-col tablet:flex-row gap-9',
              'tablet:text-start'
            )}
          >
            {/* 區塊一 */}
            <div
              className={
                'flex flex-col justify-between gap-6 mobile:gap-3 w-full basis-[37.1024%]'
              }
            >
              ...
              <div
                className={
                  'bgi-text-[var(--grayscale-100)] text-xs mobile:text-sm'
                }
              >
            ...
            {/* 區塊二 */}
            <div className={'flex flex-col gap-1 basis-[62.8976%]'}>
              <SocialList
                className={'justify-center tablet:justify-start'}
