    ...
    <div className="max-w-96 relative">
      ...
      {countdown && (
        <div className="relative">
          <div className="absolute w-full h-full text-[var(--grayscale-100)] text-3xl font-bold flex items-center justify-center ">
            <span className="border-2 border-white rounded-xl px-5">
              {hour}
            </span>
      ...
      <div className="rounded-3xl relative overflow-hidden bgi-[var(--primary-10)]">
        <img
          src={getImgUrl(
            EResourceLevel.V,
        ...
        />
        <div className="text-[var(--grayscale-100)] px-2 py-4">
          <TextKeywordMark
            i18next={{
