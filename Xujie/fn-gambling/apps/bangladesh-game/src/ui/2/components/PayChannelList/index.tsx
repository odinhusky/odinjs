      ...
      {allPayChannelActionItems.map((item, index) => (
        ...
        >
            ...
            <div className={'flex flex-col'}>
              ...
              >
                ...
                {currentRechargeCard === RechargeCard.TOP_UP_BONUS ? (
                  <span className={'ml-1 text-xs bgi-text-[var(--linear-2)]'}>
              ...
              item.payName === currentPayChannel.payName ? (
                <div className={'text-xs'}>
                  {t(`wallet_deposit_pay_with_this_channel`, {
                    cashBackRate: item.maxCashBackRate,
                  })}
                </div>
              ) : null}
          ...
          {item.isRecommend ? (
            <div
              className={
                'text-xxs bgi-text-[var(--grayscale-00)] font-medium absolute top-0 right-0 bgi-[var(--base-2-main)] rounded-bl-3xl rounded-tr-lg px-3 py-1'
              }
            >
