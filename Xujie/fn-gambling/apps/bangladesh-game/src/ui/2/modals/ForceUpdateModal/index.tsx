...
import useForceUpdateModalActions from '@libs/mode2/action/components/forceUpdateModalAcion/useForceUpdateModalActions';
import { handleCloseForceUpdateModalBtnClick } from '@libs/mode2/action/components/forceUpdateModalAcion/actionType';
    ...
    <BaseModal onClick={onClose}>
      <>
        ...
        >
          ...
          >
            Discover exciting new features and enhancements. Update now to enjoy
            the best experience!
          </div>
        </div>
