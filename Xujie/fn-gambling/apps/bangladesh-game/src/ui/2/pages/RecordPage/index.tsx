import useMode2RecordPageBase from '@/ui/hooks/pages/recordPage/useMode2RecordPageBase';
import {
  useRecordPageStore,
  RecordPageTabs,
...
import RecordPageSwitchTabs from '@pages/RecordPage/components/RecordPageSwitchTabs';
