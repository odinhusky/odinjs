...
import useMode2ChangePasswordPageBase from '@/ui/hooks/pages/changePasswordPage/useMode2ChangePasswordPageBase';
import {
...
} from '@libs/mode2/action/changePasswordPageAction/actionType';
...
const ChangePasswordPage = () => {
  ...
  const { handleChangePasswordPageClick, disabled } = useChangePasswordPageActions();
