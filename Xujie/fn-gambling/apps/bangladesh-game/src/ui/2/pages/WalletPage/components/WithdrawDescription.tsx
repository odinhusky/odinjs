  ...
  return (
    <div className={cx('gap-2 mt-5', 'bgi-text-[var(--state-warn-main)]')}>
      <div className="flex gap-2 items-center">
        <span className='bgi-text-[var(--state-error-main)] text-sm font-semibold'>*</span>
      ...
      <div className={cx('text-sm font-medium mt-1')}>
        <ul className="withdraw-note-list list-disc ml-5 bgi-text-[var(--state-warn-main)]">
          {/* <li className="bgi-text-[var(--state-warn-main)]">{noteDesc1}</li>
          <li>{noteDesc2}</li> */}
          {/* TODO i18n */}
          <li className="bgi-text-[var(--state-warn-main)]">{t('wallet_withdraw_note_1',{ percentage: BANK_COMMISSION_PERCENTAGE, flatFee: BANK_COMMISSION_FLAT_FEE })}</li>
