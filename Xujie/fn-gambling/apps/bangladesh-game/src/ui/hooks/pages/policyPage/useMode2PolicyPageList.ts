...
export const useMode2PolicyPageList = () => {
  ...
  useDeepEffect(() => {
    const policyList: IPolicyListType[] = [
      ...
      {
        i18nTitleKey:
          'privacy_policy_information_collection_title',
        i18nContentKey:
          'privacy_policy_information_collection_content',
        i18nItemKeys: [
      ...
      {
        i18nTitleKey:
          'privacy_policy_use_of_information_title',
      ...
      },
      {
        ...
        i18nContentKey:
          'privacy_policy_data_protection_content',
        i18nItemKeys: [],
      },
      {
        i18nTitleKey:
          'privacy_policy_third_party_sharing_title',
        i18nContentKey:
          'privacy_policy_third_party_sharing_content',
        i18nItemKeys: [],
      },
      {
        i18nTitleKey: 'privacy_policy_legal_compliance_title',
        i18nContentKey:
          'privacy_policy_legal_compliance_content',
        i18nItemKeys: [],
      },
      {
        i18nTitleKey:
          'privacy_policy_childrens_policy_title',
        i18nContentKey: 'privacy_policy_childrens_policy_content',
        i18nItemKeys: [],
      },
      {
        i18nTitleKey:
          'privacy_policy_update_notice_title',
        i18nContentKey:
          'privacy_policy_update_notice_content',
        i18nItemKeys: [],
      },
      {
