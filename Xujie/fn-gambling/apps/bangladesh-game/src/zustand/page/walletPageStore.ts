...
type withdrawPageDisplayDataType = {
  vipLevel: number;
  totalBalance: number;
  lockAssets: number;
  dailyWithdrawLimit: number;
  withdrawableProgress: number;
};
...
export interface WalletPageWithdrawContentStoreTypes {
  ...
  dailyWithdrawLimit: number;
  withdrawableProgress: number;
  setWithdrawPageDisplayData: (data: withdrawPageDisplayDataType) => void;
  ...
  create<WalletPageWithdrawContentStoreTypes>()(
    devtoolsAndPersistWrapper(
      ...
      (set) => ({
        ...
        withdrawableProgress: 0,
        setWithdrawPageDisplayData: (data) =>
          set(() => ({
            vipLevel: data.vipLevel,
            dailyWithdrawLimit: data.dailyWithdrawLimit,
            withdrawableProgress: data.withdrawableProgress,
            totalBalance: data.totalBalance,
            lockAssets: data.lockAssets,
          })),
