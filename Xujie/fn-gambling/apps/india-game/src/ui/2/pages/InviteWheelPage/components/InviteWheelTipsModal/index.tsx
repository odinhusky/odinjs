...
import { handleInviteWheelPageNavToShareClickAction } from '@libs/mode2/action/inviteWheelPageAction/actionType';
...
export const InviteWheelTipsModal = ({}: InviteWheelTipsModalProps) => {
  ...
  useEffect(() => {
    ...
    timerRef.current = setTimeout(() => {
      // 執行回調函式並移至下一階段
      setIsShowInviteWheelTipsModal(!isWithdrawal);
  ...
  }, [stage, timeStages, isShowInviteWheelTipsModal, isWithdrawal]);
            ...
            <div className={cx('w-full', FLEX_ITEMS_CENTER)}>
              ...
              >
                <Trans
                  ...
                  values={{
                    money: formatMoney(cashOutRewardDifference, true),
                  }}
                  components={{
                    orangeTag: (
