...
import { handleWalletGuidePageTabSelected } from '@mode2/action/walletGuidePageAction/acitonType';
...
export const WalletGuideTutorialTabs = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p className="my-2.5">
          {renderI18N({ i18nKey: 'View Video Tutorials' }, t)}
        </p>
      </div>
      ...
      >
        <p className="my-2.5">
          {renderI18N({ i18nKey: 'View Graphic Tutorial' }, t)}
        </p>
      </div>
    </div>
  );
