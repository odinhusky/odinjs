...
export const BindPlayerPhoneModal = () => {
  ...
  return isShowBindPlayerPhoneModal ? (
    <BaseModal>
      <div
        className={cx(
          ...
          <div className={cx(commonVerticalClass)}>
            ...
            >
              ...
              {!isBindPhoneAndPassword
                ...
                : 'To ensure the security of your funds, please link your mobile number and make sure to remember or securely store your password. It’s important for your account’s safety!'}
            </span>
