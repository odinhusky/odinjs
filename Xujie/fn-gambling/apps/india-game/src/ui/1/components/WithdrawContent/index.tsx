...
export const WithdrawContent = () => {
  ...
  const renderWithdrawInfoBlock = () => {
    const moneyTextClass =
      'font-medium text-base mobile:text-xl tablet:text-[32px] break-all';
    const moneyImgClass =
      'h-6 w-6 mobile:w-7 mobile:h-7 tablet:w-9 tablet:h-9 mr-[4px]';
      ...
      <div className={cx(blockClass, 'mb-[24px]')}>
        <div className={cx(FLEX_CENTER)}>
          ...
          >
            ...
            <div className={cx(labelTextClass, FLEX_CENTER)}>
              {t('wallet_withdraw_money_total_balance')}
            </div>
          </div>

          <div className={cx(FLEX_ITEMS_CENTER, 'flex-col gap-2')}>
          ...
          <div className={cx(FLEX_ITEMS_CENTER, 'justify-between')}>
            ...
            <div className="flex items-center">
              ...
              >
                ...
                <div
                  className={cx('w-full h-px', 'bgi-[var(--linear-4)]')}
                ></div>
              </div>
            </div>
          </div>
      ...
      <div className={cx(blockClass)}>
        <div className={bankItemClass}>
          ...
          >
            ...
            <div
              className={cx('w-full h-px', 'bgi-[var(--state-success-main)]')}
            ></div>
          </div>
        </div>
        <div className={bankItemClass}>
