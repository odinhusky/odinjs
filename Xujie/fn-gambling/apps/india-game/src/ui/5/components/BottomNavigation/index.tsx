...
import { handleBottomNavigationButtonClick } from '@libs/mode2/action/components/bottomNavigation/acitonType';
        ...
        {isDisplayBottomNavigation
          ? bottomNavigationList.map((item, index) => (
              ...
              >
                {item.isDrop ? (
                  <img
                    src={getImgUrl(EResourceLevel.V, 'tab_menu_drop', '.gif')}
