...
import useMoreGamePageActions from '@mode2/action/moreGamesAction/useMoreGamePageActions';
...
import useMode3MoreGamePageBaseOverride from './hooks/useMode3MoreGamePageBaseOverride';
import { normalGameImgAspectClassMode3 } from '@libs/constant/gameItemRatio';
import Icon from '@components/Icon';
import { handleMoreGamePageScrollToTopButtonClick } from '@mode2/action/actionTypes';
import debounce from 'lodash/debounce';
import { MoreGamePageTabType } from '@libs/mode2/@types/moreGamePageTabType';
import useRecentGameList from '@libs/mode2/usecase/useRecentGameList';
import MoreGamePageHorizonTab from '@components/MoreGamePageHorizonTab';
...
export const MoreGamePage = () => {
  ...
  const pureHotGameList = hotGameList?.filter(
    (item) =>
      item.isHotGame &&
  ...
  const showGameListObj = {
    ...
    [MoreGamePageTabType.HOT]: pureHotGameList || [], // Hot
    [MoreGamePageTabType.RECENT]: recentGameList || [], // Recent: 後端資料未齊全，先留空
  };
