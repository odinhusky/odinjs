...
import { handleInvitePageRankingListLastWeekBtnClick } from '@mode2/action/actionTypes';
      ...
      {!showLastData && (
        <div className={cx(FLEX_CENTER, 'flex-row', 'gap-1')}>
          ...
          <div className="time-box">
            <span className="bgi-text-[var(--linear-4)]">{hours}</span>
          </div>
          :
          <div className="time-box">
            <span className="bgi-text-[var(--linear-4)]">{minutes}</span>
          </div>
          :
          <div className="time-box">
            <span className="bgi-text-[var(--linear-4)]">{seconds}</span>
          </div>
        </div>
      )}
