...
import { handleRecordPageTabClick } from '@mode2/action/actionTypes';
    ...
    <div>
      <div className="page-tab">
        <PageTabSwitchButton
          ...
          icon={getImgUrl(EResourceLevel.ICONS, 'ic_balance_record')}
          onButtonClick={() => {
        ...
        <PageTabSwitchButton
          ...
          icon={getImgUrl(EResourceLevel.ICONS, 'ic_balance_report')}
          onButtonClick={() => {
            handleRecordPageClick({
              actionName: handleRecordPageTabClick,
