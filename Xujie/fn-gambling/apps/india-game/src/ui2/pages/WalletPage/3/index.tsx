...
import WalletPageDesktopHeader from './components/WalletPageDesktopHeader';
...
import useWalletPageSwitchTabs from '@/ui/hooks/pages/walletPage/useWalletPageSwitchTabs';
