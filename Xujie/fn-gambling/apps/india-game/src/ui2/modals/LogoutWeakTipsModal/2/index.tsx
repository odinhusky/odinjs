...
import { WeakTipsModalProps } from '@modals/WeakTipsModal/WeakTipsModalProps';
...
export const LogoutWeakTipsModal = () => {
  ...
  const modalSettings: WeakTipsModalProps = useMemo(() => {
    // 不是 User 就是 Player
    ...
    return {
      ...
      isShowDivider: !isUser,
      isShowClose: !isUser,
      titlePosition: isUser ? 'center' : 'start',
      contentPosition: isUser ? 'center' : 'start',
      content: isUser
