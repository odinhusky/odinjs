...
import { handleCollectRewardBtnClick } from '@mode2/action/actionTypes';
...
export const MoneyBoxModal = () => {
  ...
  useEffect(() => {
    if (sdkUtils.isCurrentLogin() && isShowRebateRewardModal) {
      postPiggyBankDetail();
    }
    return () => {
      ...
      <div className="relative max-w-[400px] w-[80%] bgi-[var(--base-1-main)] bgi-text-[var(--grayscale-100)] text-center mobile:pt-10 mobile:px-6 mobile:pb-6 p-4 rounded-lg">
        ...
        >
          <div className="text-base font-medium">
            ...
            {formatMoney({ value: currentCash, includeDecimal: true })}
          </div>
