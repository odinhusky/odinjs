...
import { handleFABDrawerActionClick } from '@mode2/action/actionTypes';
...
export const FloatActionButton = () => {
  ...
  const imgName = isOpenDrawer ? 'icon_float_close' : 'icon_float_open';
      ...
      <div className={'flex flex-row justify-center items-center'}>
        ...
        {isShowDrawerControlBar && !isDesktop ? (
          <BaseCacheImg
            ...
            src={getImgUrl(EResourceLevel.V, imgName)}
            imgName={imgName}
            onClick={() => {
