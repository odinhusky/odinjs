...
import { EnterGameType } from '@mode2/zustand/page/hallPageStore';
      ...
      <div className={cx('relative', props.imageClassName)}>
        ...
        <div
          className={cx('h-full w-full', {
            'border-0 rounded-lg bgi-border-[var(--base-2-main)] after-rounded-lg':
              showGameName,
          })}
        >
          {isLoadError ? (
        ...
        {((isShowHoverMask && hover) || item.isMaintain) && (
          <div
            className={cx(
              'w-full h-full absolute top-0 z-[2] rounded-lg backdrop-blur-sm',
              {
                'bgi-[var(--linear-1)]': !item.isMaintain,
                'bgi-[var(--transparent-gray-30)]': item.isMaintain,
              }
            )}
          >
            <div
            ...
            >
              {item.isMaintain ? (
                <div className="flex flex-col justify-center items-center p-1">
                  ...
                  />
                  <div className="text-sm mobile:text-base font-medium">
                    {item.maintainTime !== ''
                      ? item.maintainTime
                      : t('maintenance')}
                  </div>
