                ...
                <BasePrimaryBtn
                  ...
                  children={
                    <img
                      ...
                      src={getImgUrl(EResourceLevel.ICONS, item.icon)}
                      alt={item.label}
                    />
                  }
                />
        ...
        <div className="flex justify-center my-6">
          <div className="flex-1 flex flex-col items-center border-r-2 border-[var(--transparent-20)] gap-3">
            <div className="flex gap-2 items-center">
              <Icon name="ic_user_1" className="w-5 h-5" />
            ...
            <div className="flex gap-2 items-center">
              <Icon name="ic_game_player" className="w-5 h-5" />
          ...
          <div className="flex-1 flex flex-col items-center gap-3">
            ...
            <div className="flex gap-2 items-center">
              <Icon name="ic_winner" className="w-4 h-4" />
              <span className="bgi-text-[var(--base-1-main)] text-sm font-medium">
                {t('sign_in_winner')}
              </span>
            </div>
