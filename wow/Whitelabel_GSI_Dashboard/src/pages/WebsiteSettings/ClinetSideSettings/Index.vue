...
<script lang="ts" setup>
  ...
  const tabs = reactive({
    list: [
      /*{
        routerName: "ClinetWebSiteLanguageSettings",
        i18nKey: "menu.language_settings"
      },*/
      {
        routerName: "ClinetWebSiteSettings",
        i18nKey: "menu.website_settings"
      },
      {
        routerName: "ClinetWebSiteRegSettings",
        i18nKey: "menu.login_registration_settings"
      }
    ],
    selector: ""
  })
