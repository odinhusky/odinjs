...
<script lang="ts" setup>
  ...
  import { CMS_TYPE, LANGUAGE_TYPE, CMS_ENTRANCE_TYPE } from "src/utils/constants"
  ...
  const backRouteName = "CmsH5FooterMenuList"
  ...
  onMounted(() => {
    if (isEditMode.value && cmsId.value) {
      ...
      initCmsForm(CMS_TYPE.Enums.H5_BOTTOM_MENU)
      addCmsFormEntrance()
    }
  })
  watch(
