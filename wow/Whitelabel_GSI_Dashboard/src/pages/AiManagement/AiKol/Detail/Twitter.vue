        ...
        kolsData.value = [
          {
            ...
            following: 830,
            posts: 377,
            remark: "KOL account catwatch_jp"
          },
          {
            account: "techno_softboil",
            followers: 7849,
            following: 702,
            posts: 889,
            remark: "KOL account techno_softboil"
          },
          {
            account: "goodmorningbytes",
            followers: 9327,
            following: 570,
            posts: 742,
            remark: "KOL account goodmorningbytes"
          },
          {
            account: "dailyorbit_notes",
            followers: 9332,
            following: 907,
            posts: 597,
            remark: "KOL account dailyorbit_notes"
          }
        ]
        system_info.value = {
          total_message_count: 6869,
          total_ai_response_count: 5285,
          total_follower_request_count: 1584,
          chatbot_fee: 39693,
          status: 1
        }
        follower_growth.value = [
          {
            date: "2025-05-24",
