  ...
  <div>
    ...
    <q-card-section class="q-pb-xs" style="background-color: rgb(252, 248, 255)">
      <div class="row tab-container q-col-gutter-md">
        ...
        <div style="width: 18% !important" class="col-3">
        ...
        <div style="width: 12% !important" class="col-2">
        ...
        <div style="width: 12% !important" class="col-1">
...
<script lang="ts" setup>
  ...
  const updateAccountOption = async () => {
    await props.accountOption.forEach((item: any) => {
      const newItem = {
        label: item.account,
