          ...
          <div class="col-12">
            ...
            <div class="row items-center justify-center q-mx-auto" style="width: 17.375rem">
              ...
              <q-input
                ...
                outlined
                dense
                :placeholder="$t('common.please_enter_general_agent_id')"
                lazy-rules
                color="primary"
...
<script lang="ts" setup>
  ...
  const onSubmit = async () => {
    ...
    agentIdRef.value.validate()
    accountRef.value.validate()
    passwordRef.value.validate()
    recaptchaRef.value.validate()

    if (
      agentIdRef.value.hasError ||
      accountRef.value.hasError ||
      passwordRef.value.hasError ||
      recaptchaRef.value.hasError
    ) {
      return $q.notify({
        color: "red-5",
        textColor: "white",
    ...
    if (status.value) {
      ...
      userInfo.setGeneralAgentId(formData.agentId)
