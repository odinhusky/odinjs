            ...
            <template #body="props">
              <q-tr>
                ...
                <q-td key="status" :props="props">
                  {{
                    $t(
                      REFERRAL_COMMISSION_STATUS.I18nKeys[props.row.status as REFERRAL_COMMISSION_STATUS.Enums] ||
                        "common.unknow"
                    )
                  }}
                </q-td>
...
<script lang="ts" setup>
  ...
  import { SEND_TYPE, REFERRAL_COMMISSION_STATUS, CALCULATE_TYPE, BONUS_WALLET_TYPE } from "@/utils/constants"
  ...
  import { getReferralCommissionDetailList } from "@/api/commissionManagement"
  ...
  let { search, tableData, totalSize } = useSearch(getReferralCommissionDetailList)
