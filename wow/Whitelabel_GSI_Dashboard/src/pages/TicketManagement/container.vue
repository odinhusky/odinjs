<template>
  <q-page padding>
    ...
    <q-table :rows="row" :column="column" hide-bottom class="no-shadow" separator="cell">
...
<script>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const column = [
        { name: "center", align: "center", label: "工單號碼", field: "", sortable: false },
        { name: "Group", align: "left", label: "Group", field: "group", sortable: false },
        { name: "總代名稱", align: "left", label: "總代名稱", field: "", sortable: false },
