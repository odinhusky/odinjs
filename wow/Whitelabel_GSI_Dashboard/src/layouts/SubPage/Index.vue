    ...
    <div class="row q-col-gutter-md">
      <div class="col">
        <q-btn flat color="grey-8" size="lg" @click="onBack" class="sub-btns">
          ...
          <div class="bold h3-bold">
            {{ customTitle || $t((breadcrumbList[0] && breadcrumbList[0].name) || "btn.back_page") }}
          </div>
        </q-btn>
        <slot name="title-suffix"></slot>
        <q-btn flat fab-mini color="blue" size="sm" @click="openDialog" v-if="dialogBtn">
      ...
      <div class="col self-center q-px-md">
        <q-breadcrumbs gutter="sm" class="text-grey-8 breadcrumbWrapper" active-color="blue-7" align="right">
          ...
          <q-breadcrumbs-el :label="actionLabelI18nKey ? $t(actionLabelI18nKey) : $t('btn.edit')" />
