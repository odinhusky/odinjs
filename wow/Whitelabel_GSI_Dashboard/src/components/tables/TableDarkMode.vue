...
<script>
  ...
  const columns = [
    ...
    { name: "Crated Date", label: "Crated Date", field: "Crated_Date", sortable: false, align: "left" },
    { name: "Project", label: "Project", field: "Project", sortable: false, align: "left" },
    { name: "Progress", label: "Progress", field: "Progress", sortable: false, align: "left" },
