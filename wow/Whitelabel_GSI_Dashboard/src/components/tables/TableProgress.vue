              ...
              <q-item-section>
                <q-item-label>
                  <span class="text-blue">
                    <q-icon v-if="props.row.type == 'error'" name="bug_report" color="blue" size="20px" />
                    <q-icon v-if="props.row.type == 'info'" name="settings" color="blue" size="20px" />
                    <q-icon v-if="props.row.type == 'success'" name="flag" color="blue" size="20px" />
                    <q-icon v-if="props.row.type == 'warning'" name="fireplace" color="blue" size="20px" />
                    {{ props.row.issue }}
                  </span>
                  <q-chip
...
<script>
  ...
  const column = [
    ...
    { name: "Task", label: "Task", field: "task", sortable: false, align: "left" }
  ]
