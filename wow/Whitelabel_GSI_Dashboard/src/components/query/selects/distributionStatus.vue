...
<script lang="ts" setup>
  ...
  onMounted(() => {
    numberEnumToArray(DISTRIBUTION_STATUS.Enums).forEach((item) => {
      dropdownData.list.push({
        label: DISTRIBUTION_STATUS.I18nKeys[item as keyof typeof DISTRIBUTION_STATUS.I18nKeys] || "common.unknow",
