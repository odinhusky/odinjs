...
<script lang="ts" setup>
  ...
  import { DOCUMENTDOWNLOAD_OBJECT } from "@/utils/constants"
  ...
  onMounted(() => {
    numberEnumToArray(DOCUMENTDOWNLOAD_OBJECT.Enums).forEach((item) => {
      dropdownData.list.push({
        label:
          DOCUMENTDOWNLOAD_OBJECT.I18nKeys[item as keyof typeof DOCUMENTDOWNLOAD_OBJECT.I18nKeys] || "common.unknow",
