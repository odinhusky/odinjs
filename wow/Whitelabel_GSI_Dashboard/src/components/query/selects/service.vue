...
<script lang="ts" setup>
  ...
  onMounted(() => {
    numberEnumToArray(SERVICE_TYPE.Enums).forEach((item) => {
      dropdownData.list.push({
        label: SERVICE_TYPE.I18nKeys[item as keyof typeof SERVICE_TYPE.I18nKeys] || "common.unknow",
