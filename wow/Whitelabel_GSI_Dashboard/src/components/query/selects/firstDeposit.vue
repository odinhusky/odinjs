...
<script lang="ts" setup>
  ...
  import { FIRST_DEPOSIT_TYPE } from "@/utils/constants"
  ...
  onMounted(() => {
    numberEnumToArray(FIRST_DEPOSIT_TYPE.Enums).forEach((item) => {
      dropdownData.list.push({
        label: FIRST_DEPOSIT_TYPE.I18nKeys[item as keyof typeof FIRST_DEPOSIT_TYPE.I18nKeys] || "common.unknow",
