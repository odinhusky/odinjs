...
<script lang="ts" setup>
  ...
  import { GIFT_TYPE } from "@/utils/constants"
  ...
  onMounted(() => {
    numberEnumToArray(GIFT_TYPE.Enums).forEach((item) => {
      dropdownData.list.push({
        label: GIFT_TYPE.I18nKeys[item as keyof typeof GIFT_TYPE.I18nKeys] || "common.unknow",
