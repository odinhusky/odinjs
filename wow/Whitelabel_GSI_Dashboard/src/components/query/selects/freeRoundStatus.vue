...
<script lang="ts" setup>
  ...
  import { FREE_ROUND_STATUS } from "@/utils/constants"
  ...
  onMounted(() => {
    numberEnumToArray(FREE_ROUND_STATUS.Enums).forEach((item) => {
      dropdownData.list.push({
        label: FREE_ROUND_STATUS.I18nKeys[item as keyof typeof FREE_ROUND_STATUS.I18nKeys] || "common.unknow",
