...
<script lang="ts" setup>
  ...
  import { WARNING_STATUS } from "@/utils/constants"
  ...
  onMounted(() => {
    numberEnumToArray(WARNING_STATUS.Enums).forEach((item) => {
      dropdownData.list.push({
        label: WARNING_STATUS.I18nKeys[item as keyof typeof WARNING_STATUS.I18nKeys] || "common.unknow",
