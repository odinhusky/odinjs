...
<script lang="ts" setup>
  ...
  import { ACTIVE_STATUS_TYPE } from "@/utils/constants"
  ...
  onMounted(() => {
    numberEnumToArray(ACTIVE_STATUS_TYPE.Enums).forEach((item) => {
      dropdownData.list.push({
        label: ACTIVE_STATUS_TYPE.I18nKeys[item as keyof typeof ACTIVE_STATUS_TYPE.I18nKeys] || "common.unknow",
