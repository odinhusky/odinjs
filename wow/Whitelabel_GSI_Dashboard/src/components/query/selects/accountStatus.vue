...
<script lang="ts" setup>
  ...
  import { FROZEN_STATUS } from "@/utils/constants"
  ...
  onMounted(() => {
    numberEnumToArray(FROZEN_STATUS.Enums).forEach((item) => {
      dropdownData.list.push({
        label: FROZEN_STATUS.I18nKeys[item as keyof typeof FROZEN_STATUS.I18nKeys] || "common.unknow",
