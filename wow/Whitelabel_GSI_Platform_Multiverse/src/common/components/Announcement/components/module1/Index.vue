  ...
  <div>
    <transition name="announcement-fade" appear @after-leave="onAllContentAfterLeave">
      <AllContentAnnouncement
        ...
        :all-content-style-class="get(props.styleClass, 'allContentStyleClass', '')"
    ...
    <transition name="announcement-fade" appear @after-leave="onImageAfterLeave">
      <ImagesAnnouncement
        ...
        :images-style-class="get(props.styleClass, 'imagesStyleClass', '')"
        @close="onImageClose"
      />
    </transition>
    ...
    <transition name="announcement-fade" appear>
      <SingleAnnouncement
        ...
        :single-content-style-class="get(props.styleClass, 'singleContentStyleClass', '')"
        @close="onSingleClose"
      />
    </transition>
  </div>
