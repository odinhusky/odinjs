<template>
  <q-dialog v-model="withdrawalUploadConfig.dialogOpen">
    <q-card class="detail-dialog">
      ...
      <div v-if="withdrawalUploadConfig.dialogLoading" class="flex justify-center items-center">
        <q-circular-progress indeterminate size="50px" color="primary" />
      </div>

      <template v-else>
        <div class="data-area">
          <div class="data-area-label">{{ $t("member.withdrawal.remark") }}</div>
        ...
        <div class="data-area">
          <div class="data-area-label">{{ $t("common.btn.withdrawal") }}{{ $t("tableHeader.no") }}</div>
          <div class="data-area-content">
        ...
        <div class="data-area">
          ...
          <div class="data-area-content uploaded">
            <div v-if="uploadReadOnly && !withdrawalUploadConfig.images?.length" class="no-data">
