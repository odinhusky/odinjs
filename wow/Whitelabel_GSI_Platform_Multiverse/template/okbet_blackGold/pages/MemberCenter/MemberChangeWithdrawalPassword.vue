<template>
  <HeaderTitleBack v-if="isMobile" titleI18n="member.changePassword.setWithdrawalPassword" variant="blackGold">
    <template #left>
    ...
    .password-form-input {
      :deep(.q-field__native) {
        ...
        &:-webkit-autofill:active {
          ...
          // 強制文字顏色（例如白色）
          -webkit-text-fill-color: rgba(255, 255, 255, 0.8980392157) !important;
  ...
  &.h5 {
    ...
    .form-container {
      ...
      .form-row {
        ...
        :deep(.q-field__control) { color: #e5e7eb !important; }
        ...
        .password-form-input {
          ...
          :deep(.q-field__control) {
            &::before { border-color: rgba(146, 146, 146, 0.57); }
          }
        }
        @include phone-width {
          height: auto;
