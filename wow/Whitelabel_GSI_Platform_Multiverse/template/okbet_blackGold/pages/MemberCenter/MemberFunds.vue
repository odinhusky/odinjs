<template>
  <HeaderTitleBack title-i18n="menu.fundsDetails" variant="blackGold">
...
.wallet-container {
  ...
  .wallet-content {
    ...
    background-image: url("app/template/okbet_blackGold/assets/images/member/fund-wallet-bg.png");
