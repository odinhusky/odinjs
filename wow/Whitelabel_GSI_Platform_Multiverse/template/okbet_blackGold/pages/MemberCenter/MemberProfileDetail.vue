<template>
  <HeaderTitleBack v-if="isMobile" titleI18n="member.profile.myDetails" variant="blackGold">
...
import { COLUMN_NAME, INPUT_TYPE, LANGUAGE_TYPE } from "src/common/utils/constants"
...
:deep(.q-select__dropdown-icon) { color: #ffffffe5 !important; }
...
.profile-container.pc {
  ...
  .profile-body {
    ...
    .input-container {
      ...
      .select-placeholder {
        :deep(.q-field__inner) {
          .q-field__control {
            .q-field__native {
              span { color: $primary-white-color; }
            }
          }
        }
      }
    ...
    :deep(.q-field__marginal) { color: $primary-white-color; }
    :deep(.q-field__native, .q-field__prefix, .q-field__suffix, .q-field__input) { color: $primary-white-color; }
    :deep(.q-field--standard .q-field__control:before) { border-bottom: 1px solid $gray-border-color; }
  }
}
...
.edit-dialog {
  .dialog-card {
    ...
    .dialog-header {
      ...
      .btn-confirm { color: $secondary-gold-color; }
      .btn-cancel { color: $primary-white-color; }
      .title {
        font-weight: bold;
        max-width: 20rem;
        overflow: hidden;
    ...
    .dialog-body {
      .dialog-form-row {
        ...
        padding: 20px;
        height: 134px;
        :deep(.q-field__control) { color: $primary-white-color !important; }
        .dialog-form-title {
          font-weight: 400;
          line-height: 2.87;
      ...
      :deep(.q-field--standard .q-field__control:before) { border-bottom: 1px solid $gray-border-color; }
      :deep(.q-field__native) { color: $primary-white-color; }
    }
    @include phone-width {
      height: 350px;
      .dialog-header {
