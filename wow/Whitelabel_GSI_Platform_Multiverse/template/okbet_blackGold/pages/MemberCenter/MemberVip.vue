<template>
  ...
  <VipH5Dialog v-else title-i18n="vip.vipRewards" class="h5-vip-container" :isNeedBgBlack="true">
    <template #header>
      <div class="h5-header">
...
import VipH5Dialog from "src/common/components/okbet_blackGold/VipH5Dialog.vue"
