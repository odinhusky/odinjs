<template>
  <HeaderTitleBack titleI18n="menu.referralDetails" variant="blackGold">
          ...
          <div class="referral-summary">
            <div class="summary-item">
              <div class="summary-item-title">
                {{ $t("menu.players") }}
                <CommissionEligibilityTooltip
                  :deposit-threshold="referralSummaryData?.deposit_threshold ?? 0"
                  :valid-bet-threshold="referralSummaryData?.valid_bet_threshold ?? 0"
                />
              </div>
...
import FooterNav from "app/template/okbet_blackGold/components/Footer/FooterNav.vue"
import MobileSettingList from "app/template/okbet_blackGold/pages/HomePage/Referral/Components/MobileSettingList.vue"
import MobileDetailsList from "app/template/okbet_blackGold/pages/HomePage/Referral/Components/MobileDetailsList.vue"
import MobileSubDetailsList from "app/template/okbet_blackGold/pages/HomePage/Referral/Components/MobileSubDetailsList.vue"
import CommissionEligibilityTooltip from "src/common/components/CommissionEligibilityTooltip/Index.vue"
...
.mobile-referral-wrapper {
  ...
  .referral-summary {
    ...
    .summary-item {
      ...
      background: $secondary-gold-color;
      color: black;
  ...
  .referral-code-wrapper {
    ...
    .referral-code-button {
      ...
      @apply px-[1.25rem] text-white cursor-pointer;
      background: $secondary-gold-color;
      color: black;
    }
  }
