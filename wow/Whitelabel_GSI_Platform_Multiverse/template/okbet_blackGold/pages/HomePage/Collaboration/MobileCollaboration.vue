<template>
  <HeaderTitleBack titleI18n="menu.jointVentureAgent" variant="blackGold">
...
.mobile-collaboration-wrapper {
  ...
  .currency-select {
    ...
    .statistics {
      @apply text-black text-xs font-semibold;
    }
  ...
  .collaboration-tabs {
    ...
    :deep(.q-tab) {
      @apply rounded-[3.125rem] mr-6;
      @apply w-auto h-[2.375rem] min-h-[2.375rem] px-[1.5rem] capitalize;
      border: 1px solid $gray-border-color;
      @include iphone-width {
