    ...
    >
            ...
            <p class="help-row">
              ...
              <span class="contact-us" @click="handleOpenLiveChat">
                <div class="contact-icon">
                  <img :src="svgIcon('purple-service')" alt="phone-number" />
                </div>
                {{ $t("home.contact_us") }}
              </span>
            </p>
      ...
      <div class="form-action">
        ...
        <q-btn
          ...
          :class="{ 'disabled-state': !agreeTerms }"
          type="submit"
          :loading="isLoading"
        >
          {{ $t("common.btn.login") }}
...
@import "app/template/set_r027/assets/css/form.scss";

.label-text-color,
:deep(.label-text-color) { color: var(--text-03); }
...
.pc {
  ...
  .sms-container {
    ...
    .form-input {
      ...
      :deep(.q-field__control) { color: var(--primany-01); }
    }
    .btn-send {
      margin-left: 0.5rem;
      width: 9.375rem;
  ...
  .form-bottom {
    ...
    .terms-container {
      ...
      &::-webkit-scrollbar-thumb { background-color: var(--primany-01); }
      ...
      .term-row {
        ...
        .text-primary { color: var(--text-07, rgba(255, 224, 1, 1)) !important; }
      }
    }
    .agree-container {
      width: 100%;
      ...
      justify-content: flex-start;
      align-items: center;
      --ann-checkbox-border: 1px solid rgba(255, 255, 255, 0.45);
...
.h5 {
  ...
  .form-bottom {
    ...
    .agree-container {
      ...
      padding-top: 0.5rem;
      color: var(--neutral-01);
      --ann-checkbox-border: 1px solid rgba(255, 255, 255, 0.75);
      --ann-checkbox-svg-bg: var(--btn-bg-04);
      --ann-checkbox-svg-bg-active: var(--btn-bg-04);
...
.disabled-state {
  ...
  :deep(.q-btn__content) { cursor: not-allowed !important; }
}
</style>
