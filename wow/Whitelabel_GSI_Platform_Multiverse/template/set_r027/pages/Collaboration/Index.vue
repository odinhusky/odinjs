  ...
  <div class="collaboration-wrapper">
    ...
    <div class="collaboration-content">
      <div class="collaboration-header">
        ...
        <q-icon name="help_outline" class="collaboration-info-btn" @click="dialog = true" />
      </div>
      <div class="collaboration-currency-search">
        <div class="currency-item">
          ...
          <q-select
            ...
            map-options
            emit-value
            popup-content-class="unified-dark-dropdown-menu"
            class="form-input"
            ...
            <div class="referral-code-row">
              ...
              <div class="referral-code-btn">
                ...
                <q-icon
                  ...
                  class="referral-code-icon"
                  size="xs"
                  @click="copyMessage(collaborationState.referral_code)"
                />
              </div>
            </div>
          </div>
...
import BaseDialog from "app/template/set_r027/components/Dialog/BaseDialog.vue"
...
@import "app/template/set_r027/assets/css/table.scss";
@import "app/template/set_r027/assets/css/form2.scss";
