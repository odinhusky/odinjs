          ...
          <template v-slot:selected>
            <div class="flex flex-row align-center w-[13.75rem] phone:w-auto">
              <img
                ...
                :src="getProductTabImage({ ...selectedProduct, siteKey: 'set_r027' })"
          ...
          <template v-slot:option="scope">
            <q-item v-bind="scope.itemProps" :key="scope.opt.value">
              <q-item-section avatar>
                <img
                  :src="getProductTabImage({ product_code: scope.opt.value, siteKey: 'set_r027' })"
                  :class="cx('provider-img', 'w-auto')"
                  :alt="String(scope.opt.value)"
                  @error="setDefaultProductTabImg"
                />
              </q-item-section>
              <q-item-section>
...
import GameBanner from "app/template/set_r027/components/Banner/GameBanner.vue"
