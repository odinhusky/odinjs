    ...
    <ul class="product-list">
      ...
      >
        <div class="img-container">
          <q-img
            :src="getProductSquareImage({ ...product, siteKey: 'set_r027' })"
...
@import "app/template/set_r027/assets/css/product.scss";
...
.product-lobby-wrapper {
  ...
  .product-list {
    @apply grid grid-cols-6 gap-2 my-6;

    @include phone-width {
      @apply grid-cols-4 gap-3 px-[.875rem];
