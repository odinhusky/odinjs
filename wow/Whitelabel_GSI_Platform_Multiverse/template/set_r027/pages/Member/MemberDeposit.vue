<template>
  <div :class="cx('w-full', PAGE_X_SPACING, FLEX_CENTER)" class="deposit-layout">
    <div class="deposit-header">
      ...
      <q-menu class="member-nav-menu-r027 bg-transparent hidden phone:!block" :offset="[-20, 0]">
              ...
              <div class="col-12 col-sm-12 mr-16">
                <ul class="bank-content col-12">
                  ...
                  <li class="w-full flex items-center !justify-between">
                    ...
                    <q-img @click="copyMessage(depositState.paymentDetail.bank_name)" :src="svgIcon('copy')"></q-img>
                  </li>
                  <li class="w-full flex items-center !justify-between">
                    <span>{{ depositState.paymentDetail.bank_account }}</span>
                    <q-img @click="copyMessage(depositState.paymentDetail.bank_account)" :src="svgIcon('copy')"></q-img>
                  </li>
                  <img
