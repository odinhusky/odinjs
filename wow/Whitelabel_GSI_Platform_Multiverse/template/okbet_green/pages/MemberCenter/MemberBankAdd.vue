  ...
  >
    <q-form class="bank-add-layout h5" :class="{ '!pb-[24rem]': isTelegramMiniApp }" @submit="handleSubmit">
      ...
      <div class="action-btns row justify-center">
        <q-btn text-color="white" color="primary" label="Confirm" class="submit-btn" type="submit" :disable="bankCardRealNameSubmissionBlocked" />
      </div>
    </q-form>
  </HeaderTitleBack>
          ...
          <q-form class="form-content" @submit="handleSubmit">
            ...
            <div class="action-btns multi-btns row justify-center no-wrap">
              ...
              <q-btn
                ...
                color="primary"
                class="submit-btn"
                type="submit" :disable="bankCardRealNameSubmissionBlocked"
              />
            </div>
          </q-form>
        </div>
