<template>
  <HeaderTitleBack v-if="isMobile" titleI18n="member.changePassword.setWithdrawalPassword" variant="green">
    <template #left>
  ...
  &.pc {
    ...
    .password-header {
      ...
      .btn-close {
        ...
        min-width: auto;
        &:hover {
          :deep(.q-icon) { color: $text-dark-color; }
        }
        :deep(.q-icon) {
    ...
    .password-body {
      ...
      .form-row {
        ...
        .password-form-input {
          ...
          :deep(.q-placeholder) {
            &::placeholder { color: $sky-gray-color !important; }
          }
        }
      }
    }
    ...
    .form-container {
      ...
      .form-row {
        ...
        :deep(.q-field__control) {
          ...
          input::placeholder { color: $sky-gray-color !important; }
        }
