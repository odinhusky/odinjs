<template>
  ...
  <div class="home-layout">
    ...
    <div class="home-content" id="scrollDom" @scroll="handleInnerScroll()">
      ...
      <!-- 最新得獎跑馬燈 -->
      <div class="download-area relative" :class="cx('w-full', FLEX_JUSTIFY_CENTER)">
...
import MarqueeList from "app/template/okbet_green/components/MarqueeList/Index.vue"
...
.game-show-area
  ...
  .title-label-area
    @apply flex items-center w-full min-h-[24px]
    +iphone-width
      margin: 0rem
  .title-actions
    @apply flex items-center gap-2
