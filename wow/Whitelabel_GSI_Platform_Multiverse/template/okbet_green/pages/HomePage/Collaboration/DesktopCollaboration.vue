        ...
        <div class="referral-code-button">
          ...
          <div>
            <q-icon
              name="share"
              @click="
                copyMessage(inviteCodeUrl({ inviteCode: collaborationState.referral_code, routerName: 'HomePage' }))
              "
              class="cursor-pointer mr-1 hover:opacity-50"
              size="xs"
            ></q-icon>
            <i class="fa-solid fa-copy" @click="copyMessage(collaborationState.referral_code)"></i>
          </div>
        </div>
      </div>
      <!-- Search content -->
