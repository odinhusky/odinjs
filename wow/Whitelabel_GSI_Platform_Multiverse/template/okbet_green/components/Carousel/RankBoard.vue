<template>
  ...
  <div v-if="!isMobile" class="rank-board-wrapper pc" :class="'variant-' + variant">
  ...
  <div v-else class="rank-board-wrapper h5" :class="'variant-' + variant">
    <div class="rank-wrapper">
...
interface Props {
  variant?: "home" | "productLobby" | "default"
}
...
.rank-board-wrapper
  ...
  // Variant: Home page - apply width limitations
  &.variant-home
    max-width: 1400px
  ...
  // Variant: Product Lobby - add top margin
  &.variant-productLobby
    margin-top: 24px
