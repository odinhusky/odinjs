...
const MEMBER_ROUTE_CLASS = "bmm-set-obtd-member-route"
watch(
  () => route.path,
  (path) => {
...
.member-layout {
  ...
  &.h5 {
    ...
    background: url("app/template/bmm_set_obtd/assets/images/member/h5-bg.webp") center / contain no-repeat
...
@media (min-width: 600px) and (max-width: 1025px) {
  body.bmm-set-obtd-member-route {
