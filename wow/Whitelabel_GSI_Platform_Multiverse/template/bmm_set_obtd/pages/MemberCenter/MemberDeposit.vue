<template>
  <HeaderTitleBack v-if="isMobile" titleI18n="member.deposit.title" dialogClass="deposit-dialog-set-obtd">
...
const handleDepositSubmit = async () => {
  ...
  let { status } = (await originalHandleDepositSubmit()) as { status: boolean | undefined }
