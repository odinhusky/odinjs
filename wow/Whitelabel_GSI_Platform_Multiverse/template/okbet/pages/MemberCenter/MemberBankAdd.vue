    ...
    <q-form class="bank-add-layout h5" :class="{ '!pb-[24rem]': isTelegramMiniApp }" @submit="handleSubmit">
      ...
      <div class="withdraw-container">
        <template v-if="bankCardState.form.payment_type_id === FUND_METHOD_TYPE.Enums.BankTransfer">
          <div class="form-item row input-row p-5">
            ...
            <!-- account name -->
            <div class="row col-12 col-sm-5">
              <div class="form-title label col-12">{{ $t(bankTransferAccountNameLabel) }}</div>
              <div class="input-content col-12">
                <q-input
                  v-model="bankCardAccountName"
                  :readonly="bankCardRealNameRequired"
                  :placeholder="$t(bankTransferAccountNameLabel)"
                  lazy-rules
                  :rules="[Rules.required()]"
                />
              </div>
        ...
        <template v-if="bankCardState.form.payment_type_id === FUND_METHOD_TYPE.Enums.EWallet">
          <div class="form-item row input-row p-5">
            ...
            <!-- account name -->
            <div class="row col-12 col-sm-5">
              <div class="form-title label col-12">{{ $t(eWalletAccountNameLabel) }}</div>
              <div class="input-content col-12">
                <q-input
                  v-model="bankCardAccountName"
                  :readonly="bankCardRealNameRequired"
                  :placeholder="$t(eWalletAccountNameLabel)"
                  lazy-rules
                  :rules="[Rules.required()]"
                />
              </div>
      ...
      <div class="action-btns row justify-center">
        <q-btn
          ...
          class="submit-btn"
          type="submit"
          :disable="bankCardRealNameSubmissionBlocked"
        >
...
const bankTransferAccountNameLabel = computed<string>(() => {
  return getBankCardRealNameLabel("member.bank.accountName")
})
const eWalletAccountNameLabel = computed<string>(() => {
  return getBankCardRealNameLabel(getAccountNameLabel(currentPaymentGatewayName.value, currentPgCode.value))
})
