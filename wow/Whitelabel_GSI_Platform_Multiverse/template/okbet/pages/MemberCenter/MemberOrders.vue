            ...
            >
              ...
              <q-card>
                <q-card-section>
                  ...
                  <span
                    class="text link"
                    @click="handleUploadDetail(pending.trans_code, true, pending.needUploadDetailFundType)"
                    >{{ pending.trans_code }}</span
                  >
                </q-card-section>
                <q-card-section>
        ...
        <template #body="props">
          <q-tr>
            ...
            <q-td key="no" :props="props" class="custom-td" width="100px">
              <a @click="handleUploadDetail(props.row.trans_code, true, props.row.needUploadDetailFundType)">{{
