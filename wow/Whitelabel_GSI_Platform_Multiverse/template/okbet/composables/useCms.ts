...
import { isCmsEntranceActive as isCommonCmsEntranceActive, useCms } from "src/common/composables/useCms"
...
export function isCmsEntranceActive(entrance: Response.CmsEntranceItem | undefined, route: RouteLocationNormalizedLoaded) {
  return isCommonCmsEntranceActive(entrance, route, (did) => MENU.RouterNameMapping[did as keyof typeof MENU.RouterNameMapping])
}
