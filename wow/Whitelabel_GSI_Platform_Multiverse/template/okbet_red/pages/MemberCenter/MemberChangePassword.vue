<template>
  <HeaderTitleBack v-if="isMobile" titleI18n="member.changePassword.passwordSetting" variant="red">
    <q-form @submit="handleSubmit" class="password-container h5">
      ...
      <div class="submit-container">
        <q-btn unelevated color="primary" text-color="black" type="submit" class="btn-submit">{{
