<template>
  <HeaderTitleBack v-if="isMobile" titleI18n="member.changePassword.setWithdrawalPassword" variant="red">
    <template #left>
    ...
    <q-form @submit="handleSubmit" class="password-container h5">
      <div class="form-container">
        ...
        <div v-if="userInfo2.has_withdrawal_password" class="form-row">
          ...
          <q-input
            ...
            class="password-form-input custom-border white-input-error input-text-white"
      ...
      <div class="submit-container">
        <q-btn unelevated color="primary" text-color="black" type="submit" class="btn-submit">{{ $t("common.btn.confirm") }}</q-btn>
      </div>
    </q-form>
  </HeaderTitleBack>
    ...
    <q-card class="password-container pc">
      <q-form @submit="handleSubmit" @reset="resetWithdrawalPasswordForm">
        ...
        <q-card-section class="password-footer">
          ...
          <q-btn outline color="white" type="reset">{{ $t("common.btn.reset") }}</q-btn>
        </q-card-section>
      </q-form>
    </q-card>
  </q-dialog>
...
.password-form-input {
  :deep(.q-field__native) {
    ...
    &:-webkit-autofill:active {
      ...
      box-shadow: 0 0 0px 1000px $primary-color inset !important;
      // 強制文字顏色（例如白色）
