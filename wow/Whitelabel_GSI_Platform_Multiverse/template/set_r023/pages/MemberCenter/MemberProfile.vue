  ...
  <HeaderTitleBack v-if="isLargeTablet" variant="setR022" :title-i18n="'menu.profile'">
    ...
    <div class="h5-profile-area">
      ...
      <div class="cms-area">
        ...
        >
          <div>{{ item.lang?.[nowLang as LANGUAGE_TYPE.Enums] || item.column_name }}</div>
          <div class="flex items-center justify-center">
            <span class="mr-1">
    ...
    <div class="detail-area">
      ...
      <template v-for="item in memberColumnList" :key="item.column_name">
        <div class="detail-data" :class="{ '!cursor-default': !item.edit }" @click="handlerShowEditDialog(item)">
          <div class="data-left">
            <div class="detail-title">
              {{ item.lang?.[nowLang as LANGUAGE_TYPE.Enums] || item.column_name }}
            </div>
            <div class="user-data">
...
import { COLUMN_NAME,LANGUAGE_TYPE } from "src/common/utils/constants"
