<template>
  <div class="vip-card" :class="{ 'is-dark': $q.dark.isActive }">
...
.vip-card {
  width: 41.25rem;
  min-height: 21.25rem;
  background-image: url("app/template/set_r023/assets/images/vip/bg-card.png");
  ...
  &.is-dark {
    background-image: url("app/template/set_r023/assets/images/vip/bg-card-dark.png");
  }
