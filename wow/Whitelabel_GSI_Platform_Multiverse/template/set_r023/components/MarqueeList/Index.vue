<template>
  <div v-if="marqueeAnnouncements.length" class="marquee-area">
...
.marquee-area {
  @apply flex items-center gap-3 px-4 w-full;
  border-radius: 999px;
  height: 2.3755rem;
  ...
  .marquee-item {
    background-image: linear-gradient(to right, var(--ticker-01) 0%, var(--ticker-02) 38%, var(--ticker-03) 100%);
