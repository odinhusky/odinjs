<template>
  <q-drawer :width="isLargeTablet ? 312 : 244" show-if-above v-model="drawer" side="left" class="drawer-wrapper">
    <div class="drawer-content">
      ...
      <div v-show="isLogin && isLargeTablet" @click="logout" :loading="isLoading" class="logout-btn">
...
.deposit-btn {
  @apply bg-[var(--emotional-warning-02)];
}

.withdrawal-btn {
  @apply bg-[var(--primary-04)]; // Changed from primary-04 to emotional-warning-02
}
