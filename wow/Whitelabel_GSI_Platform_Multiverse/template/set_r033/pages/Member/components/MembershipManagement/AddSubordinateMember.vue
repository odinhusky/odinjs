            ...
            <div class="setting-section">
              ...
              <div class="setting-control">
                <q-btn-toggle
                  ...
                  :options="[
                    { label: $t('member.membershipManagement.enable'), value: true },
                    { label: $t('member.membershipManagement.disable'), value: false },
                  ]"
                  no-caps
                  unelevated
...
.add-subordinate-member-area {
  ...
  .back-btn {
    ...
    gap: 0.625rem;
    cursor: pointer;
    border: 1px solid var(--btn-bg-01);
  ...
  .data-area {
    ...
    .step-indicator {
      ...
      .step-circle {
        ...
        height: 2.5rem;
        border-radius: 50%;
        border: 1px solid var(--input-dropdown-text-03);
        ...
        font-size: 0.875rem;
        &.active {
          border: 3px solid var(--btn-bg-01);
        }
      ...
      .step-line {
        width: 4rem;
        height: 2px;
        background: var(--input-dropdown-text-03);
        transition: all 0.3s ease;
    ...
    .step-content {
      ...
      .step-1 {
        ...
        // 對齊 set_r017：三個都是 account-toggle 膠囊（--tab-bg-01/02 在 set_r033 = 金色）
      ...
      .step-2 {
        ...
        // checkbox 框：未勾選邊框用主題灰（預設繼承黑字），勾選時填品牌金
        :deep(.q-checkbox__bg) {
        ...
        :deep(.q-checkbox__inner--truthy .q-checkbox__bg) {
          background: var(--btn-bg-01) !important;
          border-color: var(--btn-bg-01) !important;
        }

        // checkbox 文字改用主題色（預設是黑字）
    ...
    .step-navigation {
      ...
      .nav-btn {
        ...
        &.previous {
          background: transparent;
          color: var(--btn-bg-01);
          border: 2px solid var(--btn-bg-01);
