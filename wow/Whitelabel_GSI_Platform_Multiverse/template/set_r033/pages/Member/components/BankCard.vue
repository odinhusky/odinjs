<template>
  ...
  >
    ...
    <div
      class="card-content"
      v-show="props.card.payment_type_id === FUND_METHOD_TYPE.Enums.CryptoPayment && props.card.payment_gateway_id"
    >
  ...
  <div v-else class="card" :class="{ active: props.activeId === props.card.id }">
    ...
    <div class="card-content">
      <div class="content-title">
        {{ $t(getDisplayedBankCardAccountNameLabel(props.card, props.gatewayFilterList, getAccountNameLabel(props.card.payment_gateway_name, props.card.pg_code))) }}
      </div>
      <div class="content-value">{{ getDisplayedBankCardAccountName(props.card, props.gatewayFilterList) }}</div>
    </div>
    <div class="card-content">
      <div class="content-title">
        {{ $t(getAccountNumberLabel(props.card.payment_gateway_name, props.card.pg_code)) }}
      </div>
