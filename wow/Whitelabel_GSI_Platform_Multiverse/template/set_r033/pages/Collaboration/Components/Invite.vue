          ...
          <div v-for="(item, index) in invitationState.list" :key="index" class="w-full">
            <q-expansion-item dense dense-toggle expand-separator class="mobile-item" header-class="mobile-item-header">
              <template v-slot:header>
                ...
                <div class="header-item">
                  <div class="header-item-value text-right">
                    <span
                      class="domain-status"
                      :class="{
              ...
              <q-list class="mobile-item-body">
                <q-item class="body-item">
                  <span class="body-item-title">{{ $t("collaboration.deposit_count") }}</span>
                  <span class="body-item-value">{{ moneyFormat(item.deposit_count) }}</span>
                </q-item>
                <q-item class="body-item">
                  <span class="body-item-title">{{ $t("collaboration.currency") }}</span>
                  <span class="body-item-value">{{ item.currency_code }}</span>
                </q-item>
                <q-item class="body-item">
...
@import "app/template/set_r033/assets/css/table.scss";
...
.search-content {
  ...
  .search-row {
    @apply mt-5 flex flex-nowrap items-center gap-5;
