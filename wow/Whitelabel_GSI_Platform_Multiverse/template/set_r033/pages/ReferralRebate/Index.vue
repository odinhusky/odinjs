...
<!--
  r017 無亮暗模式，q-date popup 是 teleport 到 body 的，直接用全局 .q-date 覆蓋。
  顏色全部改用 _variable.scss 對應變數：
    --primany-01: #F26319 / --primany-02: #D12D00
    --secondary-11: #0C0C1C / --neutral-01: #ffffff
    $gradient01 = linear-gradient(90deg, $primany01, $primany02)
-->
<style lang="scss">
@import "app/template/set_r033/assets/css/_variable.scss";

// ── q-date popup 覆蓋（r017：無亮暗模式）──────────────────────────
// 在 .q-date 層級覆蓋 --q-primary，讓 Quasar 的 .bg-primary 自動用主題色
.q-date {
  // 覆蓋 --q-primary 為主題橘（--primany-01），用於 today 外框、選中日期等
  --q-primary: var(--primany-01);

  // 整體背景（--secondary-11: #0C0C1C）
  background: var(--secondary-11) !important;
  color: var(--neutral-01);

  // header 區 —— 使用 $gradient01（linear-gradient(90deg, #F26319, #D12D00)）
  .q-date__header {
...
@import "app/template/set_r033/assets/css/_variable.scss";
@import "app/template/set_r033/assets/css/referral-rebate.scss";
</style>
