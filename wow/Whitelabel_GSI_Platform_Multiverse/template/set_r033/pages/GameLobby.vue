          ...
          <template v-slot:selected>
            <div class="flex flex-row align-center w-[13.75rem] phone:w-auto">
              <img
                ...
                :src="getProductTabImage({ ...selectedProduct, siteKey: 'set_r033' })"
          ...
          <template v-slot:option="scope">
            <q-item v-bind="scope.itemProps" :key="scope.opt.value">
              <q-item-section avatar>
                <img
                  :src="getProductTabImage({ product_code: scope.opt.value, siteKey: 'set_r033' })"
                  :class="cx('provider-img', 'w-auto')"
                  :alt="scope.opt.value"
                  @error="setDefaultProductTabImg"
                />
...
@import "app/template/set_r033/assets/css/form.scss";
@import "app/template/set_r033/assets/css/common.scss";
@import "app/template/set_r033/assets/css/game.scss";
@import "app/template/set_r033/assets/css/button.scss";
