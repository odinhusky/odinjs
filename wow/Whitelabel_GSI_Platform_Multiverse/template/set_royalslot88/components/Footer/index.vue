        ...
        <div class="desktop_footer_wrap">
          <div class="desktop_footer_wrap_left">
            ...
            >
              ...
              <div class="footer_p_name">
                {{ cmsItem.Setting.lang[nowLang as LANGUAGE_TYPE.Enums] || cmsItem.Setting.lang["en"] }}
              </div>
            </a>
          </div>
          ...
          <template v-for="cmsItem in h5BottomMenuList.slice(0, 6)" :key="cmsItem.id">
            ...
            >
              <img
                ...
                :alt="cmsItem.Setting.lang[nowLang as LANGUAGE_TYPE.Enums] || cmsItem.Setting.lang['en']"
              />
              <div class="footer_p_name">
                {{ cmsItem.Setting.lang[nowLang as LANGUAGE_TYPE.Enums] || cmsItem.Setting.lang["en"] }}
              </div>
