  ...
  <div :class="`${ isDown.phone ? 'h5' : 'pc' }`">
    ...
    >
          ...
          <div class="terms-container">
            <div class="term-row">
              <span>
                ...
                <router-link :to="{ name: 'webInformation', params: { id: 3 } }" target="_blank" class="text-primary">
            ...
            <div class="term-row">
              <span>
                ...
                <router-link :to="{ name: 'webInformation', params: { id: 2 } }" target="_blank" class="text-primary">
      ...
      <div class="form-action">
        <!-- 登入按鈕 -->
        <q-btn class="btn-submit mt-6 hide-hover" type="submit" :disable="!agreeTerms" :loading="isLoading">
          {{ $t("common.btn.login") }}
        </q-btn>
...
function _handlePhoneInput(val: string) { formLogin.phone = val.replace(/[^0-9]/g, "") }
...
function changeDialog(status: boolean) {
  ...
  formLogin.sms_otp = ""
  formLogin.country = ""
  formRegister.value = { is_customize: true }
...
.label-text-color,
:deep(.label-text-color) { color: var(--neutral-01); }

.sms-country-phone-row {
  @apply flex flex-nowrap gap-2;

  :deep(.q-field__inner) {
    i { color: var(--neutral-01); }
  }
}
...
.pc {
  ...
  .form-input-container { min-width: 8rem; }
  ...
  .sms-container {
    ...
    .form-input {
      ...
      :deep(.q-field__control) { color: var(--btn-bg-01); }
    }
    .btn-send {
      margin-left: 0.5rem;
      width: 9.375rem;
  ...
  .form-bottom {
    ...
    .terms-container {
      ...
      &::-webkit-scrollbar-thumb { background-color: var(--btn-bg-01); }
...
:deep(.text-red) { color: var(--primany-02) !important; }

:deep(.text-primary) { color: var(--primany-02) !important; }

:deep(.text-term) { color: var(--primany-02) !important; }
</style>
