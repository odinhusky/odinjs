      ...
      <q-form @submit="handleDepositSubmit">
        <div class="profile-form column">
          <div class="form-content">
            <!-- currency -->
            <div v-if="showDepositCurrencyArea" class="!!ml-0" :class="cx('currency-item', 'form-item', 'row')">
            ...
            <!-- type -->
            <div v-if="showDepositTypeArea" class="!ml-0" :class="cx('type-item', 'form-item', 'row')">
            ...
            <!-- 支付方式 -->
            <div class="!ml-0 mb-2 form-item row">
            ...
            <!-- 支付資訊 -->
            <div class="!ml-0 mb-2 form-item row" v-if="depositState.usingFundType === 'BankTransfer'">
              <div class="col-12 col-sm-12 mr-16">
                <ul class="bank-content col-12">
                  ...
                  <li class="w-full flex items-center !justify-between">
                    ...
                    <q-img @click="copyMessage(depositState.paymentDetail.bank_name)" :src="copySvg"></q-img>
                  </li>
                  <li class="w-full flex items-center !justify-between">
                    <span>{{ depositState.paymentDetail.bank_account }}</span>
                    <q-img @click="copyMessage(depositState.paymentDetail.bank_account)" :src="copySvg"></q-img>
                  </li>
                  <img
              ...
              <div v-if="hasFee(depositState.paymentDetail)" class="!ml-0 col-12 col-sm-12 mr-16">
            ...
            <div class="!ml-0 mb-2 form-item row" v-else-if="depositState.usingFundType === 'CryptoWallet'">
              <div class="col-12 col-sm-12 mr-16">
                ...
                <ul class="bank-content col-12">
                  ...
                  <li class="w-full flex items-center !justify-between">
                    ...
                    <q-img @click="copyMessage(depositState.paymentDetail.wallet_address)" :src="copySvg"></q-img>
                  </li>
                  <img
                    v-if="depositState.paymentDetail.qrcode_image_id !== 0"
                    :src="depositState.paymentDetail.imgUrl"
            ...
            <div class="!ml-0 mb-2 form-item row" v-else-if="depositState.usingFundType === 'CryptoPayment'">
              <div class="col-12 col-sm-12 mr-16">
                <div class="form-title label col-12">{{ $t("member.deposit.depositInfo") }}</div>
                <ul class="bank-content col-12">
                  <li class="w-full flex items-center !justify-between">
            ...
            <div class="!ml-0 form-item mb-2" v-show="depositState.paymentDetail.usdt_rate">
              <ul>
                <li>
            ...
            <!-- 額外欄位 -->
            <div class="!ml-0 form-item row" v-if="depositState.paymentDetail.extra_field_key">
              <div class="row col-12">
                ...
                >
                  <!-- 文字輸入框 -->
                  <ExtraInput
                    v-if="isDepositExtraFieldVisible(field) && field.type === FIELD_TYPE.Enums.Input"
                  ...
                  <!-- 下拉選單類型 -->
                  <ExtraSelect
                    v-else-if="isDepositExtraFieldVisible(field) && field.type === FIELD_TYPE.Enums.Select"
                    v-model="depositState.form[depositState.paymentDetail.extra_field_key][field.field_name]"
                    :field="field"
                    optionStyle="option-style"
                    class="form-input"
                  ...
                  <!-- 其他 -->
                  <ExtraInput
                    v-else-if="isDepositExtraFieldVisible(field)"
                    v-model="depositState.form[depositState.paymentDetail.extra_field_key][field.field_name]"
                    :field="field"
                    class="form-input"
                  ></ExtraInput>
            ...
            <!-- 活動 -->
            <div class="!ml-0 mb-5 form-item row" v-if="depositState.promotion_list.length > 0">
            ...
            <div class="!ml-0 form-item row" v-if="depositState.uploadConfig.uploadSwitch && needUploadDetailFundType">
            ...
            <div class="!ml-0 action-btns row justify-center">
...
// 金額欄位初始設 readonly，使用者 focus 時才解除，避免瀏覽器（尤其 Windows Chrome）自動帶入帳號資訊
