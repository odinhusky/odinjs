  ...
  <section class="desktop-agent-wrapper">
    <div class="desktop-agent-container">
      ...
      <div class="setting-bet-card-container">
        ...
        <MockGameFirst data-theme="set_r030" />
        <MockGameSecond data-theme="set_r030" />
        <MockGameThird data-theme="set_r030" />
      </div>
    </div>
...
@import "app/template/set_r030/assets/css/agent.scss";
