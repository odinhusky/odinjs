<template>
  ...
  <q-dialog
    ...
    class="claim-gift-dialog claim-gift-dialog-wrapper font-bold text-white"
  >
...
.claim-gift-dialog {
  ...
  .claim-select-wrapper {
    ...
    background: var(--input-dropdown-bg-01, #0c0c1c);
    border: 1px solid var(--input-dropdown-border-01, #d2d2d23d);
...
.gift-card-container {
  ...
  .gift-confirm-btn {
    @apply font-bold text-[0.75rem] leading-[1rem] w-full;
    color: var(--btn-text-01, #ffffff);
    background: $bg-gradient-red01;
