<template>
  <div id="slide_right" class="slide_right_close srl_menu">
    <ul v-if="cmsContactUsList.length > 0" class="list_menu menu-container">
      <li
...
.contact-list {
  @apply flex flex-col items-center bg-[#D72F2F] cursor-pointer;
  padding: 0.3125rem 0rem;
}

.contact-title {
  @apply flex justify-center items-center w-[10.375rem] bg-[#D72F2F];
  padding: 0.5rem 0rem;
