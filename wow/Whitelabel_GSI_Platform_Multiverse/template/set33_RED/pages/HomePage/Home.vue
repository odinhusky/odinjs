  ...
  <div class="home">
    <div class="header-partial-conatiner">
      <Carousel :wrap-around="true" v-if="bannerList.length">
        ...
        <Slide v-for="(banner, index) in bannerList" :key="index" @click="handleBannerRedirect(banner)">
          <div class="carousel__item">
            <BannerImage :banner="banner" class="banner-item" />
          </div>
        </Slide>
      ...
      <div class="step-bar">
        <div class="step_container">
          <div class="step-in">
            <ul class="flex">
              <li class="flex-1">
                <div class="flex w-full step-1">
                  <div class="step-icon">
                    <img width="100px" :src="homeImg('step-1.png')" />
                  </div>
                  <div class="step-text">
                    <h4>{{ $t("home.joinUs") }}</h4>
              ...
              <li class="relative w-[50px]">
                <img class="h-full absolute top-0 bottom-0" :src="homeImg('step-line.png')" alt="" />
              </li>
              <li class="flex-1">
                <div class="flex justify-center w-full step-2">
                  <div class="step-icon">
                    <img width="100px" :src="homeImg('step-2.png')" />
                  </div>
                  <div class="step-text">
              ...
              <li class="flex-1">
                <div class="flex justify-center w-full step-3">
                  <div class="step-icon ml-auto">
                    <img width="100px" :src="homeImg('step-3.png')" />
                  </div>
                  <div class="step-text">
      ...
      <div class="home_container">
        <!-- 串接 CMS 首頁入口列表 -->
        <div v-if="cmsHomeList.length" class="game-list">
        ...
        <div v-if="cmsHomeInformationImageList.length" class="game-type-item">
          <div class="ttl-inx">
            <div class="ttl-inx-l">
              <span><i class="fas fa-info"></i></span>
              {{ cmsHomeInformationImageList[0].Setting.lang[nowLang as LANGUAGE_TYPE.Enums] }}
            </div>
          </div>
          <div class="index-info">
            <div class="inx-bnr">
              <q-img
                @click="handleEntranceClick(cmsHomeInformationImageList[0].Entrance[0])"
                :src="cmsHomeInformationImageList[0].Setting.img_lang[nowLang as LANGUAGE_TYPE.Enums]"
                class="cursor-pointer"
                contain
              />
            </div>
            <div class="inx-bnr-2">
              <div v-if="cmsHomeInformationImageList.length > 1" class="in-info">
                <ul class="mb-3 nav nav-pills index-tab" id="pills-tab" role="tablist">
                  <li
                    v-for="(item, index) in cmsHomeInformationImageList.slice(1)"
                    :key="index"
                    class="nav-item"
                  >
                ...
                <div class="tab-content index-tab-content" id="pills-tabContent">
                  <div
                    v-for="(item, cmsIndex) in cmsHomeInformationImageList.slice(1)"
                    :key="cmsIndex"
                    class="tab-pane fade"
        ...
        <Leaderboard v-if="envInfo.leaderboard_enabled" />
      </div>
      <!--end-->
    </div>
  </div>
    ...
    .container-fluid
      ...
      .annouc-wrap
        ...
        .annoucement-text
          ...
          align-items: center
  .step-bar
    background: linear-gradient(270deg, #410000 0%, #D72F2F 49%, #410000 100%)
    +iphone-width
      display: none
    .step_container
      max-width: 85.375rem
      ...
      .index-info
        ...
        .inx-bnr-2
          ...
          .in-info ul
            ...
            border-bottom: .0625rem solid #C4A242
            ...
            li
              ...
              .nav-link
                ...
                display: block
              .active
                background: linear-gradient(90deg, #F5E986 0%, #C4A242 100%)
                border-radius: .625rem .625rem 0 0
                border: 1px solid
                border-image-source: linear-gradient(90deg, #F5E986 0%, #C4A242 100%)
