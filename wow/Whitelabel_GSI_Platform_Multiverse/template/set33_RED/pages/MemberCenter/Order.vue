<template>
  <div>
    ...
    <q-table
      v-if="!isMobile"
      class="inbox-table custom-scroll-container"
      color="primary"
          ...
          <template v-slot:header>
            ...
            <q-item-section side>
              <div class="expansion-header-currency">
                <img :src="pendingImg(currencyName(pending.currency))" />
...
.custom-scroll-container
  scrollbar-color: rgb(245, 233, 134) rgb(61, 2, 2)
