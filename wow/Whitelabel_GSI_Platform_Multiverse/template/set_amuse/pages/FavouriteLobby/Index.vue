<template>
  <div class="game-container">
    ...
    <div class="search-area">
      <GameKeywordSearch v-model="searchKeyword" class="search-container" />
    </div>
    <q-separator />
    <div class="game-row">
      <div
        v-for="(game, index) in displayFavoriteGames"
      ...
      >
        ...
        <q-btn class="btn-favorite hide-hover" round flat @click.stop="removeFavorite(game, true)">
...
const { removeFavorite } = useProviderFavoriteActions()
...
const favoriteGames = computed(() =>
  allCachedGames.value.filter((game) => isProviderGameFavorited(game.game_id, favoriteMap.value))
)

const displayFavoriteGames = computed(() => {
