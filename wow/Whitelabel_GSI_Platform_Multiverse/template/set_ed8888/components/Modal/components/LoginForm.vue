        ...
        >
          <div class="field-input">
            <q-input
              ...
              class="input-control form-control !pt-0"
              dense
              borderless
              lazy-rules
              color="black"
...
// Override autofill border-radius
:deep(input:-webkit-autofill),
:deep(input:-webkit-autofill:hover),
:deep(input:-webkit-autofill:focus),
:deep(input:-webkit-autofill:active) { border-radius: 0px !important; }

.label-text-colo,
:deep(.label-text-color) { color: $common-black-color; }

.btn-forgot-password {
  .forgot-text {
    @apply text-[.875rem] text-black cursor-pointer;
...
:global(.ed8888-country-popup .q-item__label) { color: $common-white-color !important; }
</style>
