  ...
  <div class="vip-card">
    ...
    <div v-else class="multi-progress-container">
      ...
      <div v-else class="single-condition">
        ...
        <template v-if="nextVipData.promotion_condition === PROMOTION_CONDITION.Enums.DEPOSIT">
          <div class="progress-content">
            <p class="progress-type">
              {{ $t("vip.deposit") }}
            </p>
...
.vip-card {
  ...
  min-height: 21.25rem;
  background-image:
    url("app/template/set_ed8888/assets/images/vip/bg-card.png"),
    linear-gradient(to right, rgb(64, 0, 1), rgb(64, 0, 1));
