<template>
  <HeaderTitleBack v-if="isLargeTablet" title-i18n="collaboration.title">
    <template #right>
      <q-icon name="help" class="tip-icon cursor-pointer" @click="handleShowTip" />
    </template>
  ...
  <div v-else class="collaboration">
    <div class="collaboration-content">
      ...
      <div class="title text-nowrap">
        ...
        <q-icon name="help" class="tip-icon cursor-pointer ml-1" @click="handleShowTip" />
      </div>
...
@import "app/template/set_r032/assets/css/collaboration.scss";
</style>
