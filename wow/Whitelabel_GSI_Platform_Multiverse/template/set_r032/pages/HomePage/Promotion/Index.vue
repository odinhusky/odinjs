...
import PromotionDetailDialog from "app/template/set_r032/pages/HomePage/Promotion/PromotionDetailDialog.vue"
...
.promotion-wrapper {
  ...
  .promotion-content {
    ...
    .promotion-list {
      @apply mt-2 grid grid-cols-2 gap-[.9375rem] px-4 py-4;
