<template>
  <section class="contact-us-wrapper">
    ...
    <ul v-if="cmsContactUsList.length > 0" class="contact-list-wrapper">
      <li
        v-for="(cmsItem, index) in cmsContactUsList"
        :key="index"
        class="contact-item"
...
.contact-us-wrapper {
  ...
  @apply max-w-[87.5rem] py-[1.875rem] px-[.625rem] pt-[2.5rem];
