  ...
  <section class="withdraw-wrapper">
    <q-form @submit="handleSubmit">
      ...
      <div class="form-row field-input flex flex-col pay-area overflow-hidden">
        ...
        <div
          v-if="withdrawState.paymentDetail.withdraw_min && withdrawState.paymentDetail.withdraw_max"
      ...
      <div class="pay-area">
        <div class="wrap">
          <table>
            ...
            <!-- <tr v-if="showWithdrawWalletSummary">
...
const withdrawableBalance = computed(() => {
  try {
    return inUseWallet.value?.[WALLET_TYPE.Enums.Cash]?.withdrawable_balance || 0
  } catch (error) {
    return 0
  }
})
...
.pay-area {
  ...
  &.money-background {
    border-radius: 12px;
    background: linear-gradient(0deg, var(--neutral-01) 39.9%, var(--neutral-02) 100%);
