        ...
        <div class="tab-area">
          <div class="tab-item" :class="{ active: dialogType === 'deposit' }" @click="changeDialogType('deposit')">
            <img
              :src="
                resultImages(
                  `member/deposit${dialogType === 'deposit' ? '-select' : ''}${$q.dark.isActive ? '-dark' : ''}.svg`
                )
              "
              class="mr-1 w-5 h-5"
            />
          ...
          >
            <img
              :src="
                resultImages(
                  `member/withdraw${dialogType === 'withdrawal' ? '-select' : ''}${$q.dark.isActive ? '-dark' : ''}.svg`
                )
              "
              class="mr-1 w-5 h-5"
            />
            ...
            <div class="tab-wrapper mobile">
              <div class="tab-area">
                <div class="tab-item active" @click="changeDialogType('deposit')">
                  <img
                    :src="resultImages(`member/deposit-select${$q.dark.isActive ? '-dark' : ''}.svg`)"
                    class="mr-1 w-5 h-5"
                  />
                  {{ t("menu.deposit") }}
                </div>
                <div class="tab-item" @click="changeDialogType('withdrawal')">
                  <img
                    :src="resultImages(`member/withdraw${$q.dark.isActive ? '-dark' : ''}.svg`)"
                    class="mr-1 w-5 h-5"
                  />
                  {{ t("menu.withdrawal") }}
                </div>
            ...
            <div class="tab-wrapper mobile">
              <div class="tab-area">
                <div class="tab-item" @click="changeDialogType('deposit')">
                  <img
                    :src="resultImages(`member/deposit${$q.dark.isActive ? '-dark' : ''}.svg`)"
                    class="mr-1 w-5 h-5"
                  />
                  {{ t("menu.deposit") }}
                </div>
                <div class="tab-item active" @click="changeDialogType('withdrawal')">
                  <img
                    :src="resultImages(`member/withdraw-select${$q.dark.isActive ? '-dark' : ''}.svg`)"
                    class="mr-1 w-5 h-5"
                  />
                  {{ t("menu.withdrawal") }}
                </div>
