          ...
          <template v-if="isLoginOtpEnabled && formLogin.login_method === LOGIN_METHOD.Enums.Sms">
            <div class="sms-country-phone-row">
              ...
              <q-select
                ...
                class="form-input border-bottom border-bottom-full flex-[1] phone-country-select"
                dense
                borderless
              ...
              <q-input
                ...
                ref="phoneRef"
                class="input-control form-input border-bottom border-bottom-full flex-[2]"
                dense
                borderless
...
.sms-country-phone-row { @apply flex flex-nowrap gap-2; }
...
.h5 {
  ...
  .form-container {
    ...
    :deep(.q-field__bottom) { color: $functional-line !important; }
  }
  .btn-submit {
...
.pc .input-control {
  :deep(.q-field__native) {
    ...
    &:-webkit-autofill:active {
      // 使用巨大的內陰影覆蓋背景色
      -webkit-box-shadow: 0 0 0px 1000px $secondary-card-secondary inset !important;
      box-shadow: 0 0 0px 1000px $secondary-card-secondary inset !important;
    }
  }
}
...
.phone-country-select {
  ...
  :deep(.q-field__marginal .q-icon) { color: $text-sky-gray-color !important; }
}
</style>
