<template>
  <HeaderTitleBack v-if="isDown.pc" title-i18n="member.mail.messageCenter" variant="blueOrange">
    ...
    <div class="header">
      ...
      <div class="flex">
        <div class="flex items-center justify-start">
          <q-btn rounded flat icon="mail" class="btn-mail inbox-btn" color="white">
            <q-badge
  ...
  <!-- dialog -->
  <q-dialog v-model="modalShow" @hide="initMailDetail" :persistent="!isDown.pc">
    <q-card v-if="isDown.pc" class="dialog h5">
...
import { QScrollAreaProps, QTableProps, useQuasar } from "quasar"
