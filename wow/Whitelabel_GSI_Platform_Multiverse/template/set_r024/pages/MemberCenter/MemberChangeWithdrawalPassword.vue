<template>
  <HeaderTitleBack v-if="isDown.pc" titleI18n="member.changePassword.setWithdrawalPassword" variant="blueOrange">
    <template #left>
...
.password-container {
      ...
      .form-row {
        ...
        .password-form-input {
          ...
          :deep(.q-field__control) {
            input { color: $neutral-01 !important; }
          }
          :deep(.q-placeholder) {
            &::placeholder { color: $neutral-01 !important; }
          }
          :deep(.q-icon) { color: $neutral-01 !important; }
        }
      }
    }
    .password-footer {
    ...
    .form-container {
      ...
      .form-row {
        ...
        :deep(.q-field__control) {
          ...
          input::placeholder { color: $neutral-01 !important; }
        }
  ...
  :deep(.q-field--standard .q-field__control:before) { border-bottom: 1px solid $functional-line; }
}

.btn-back {
  :deep(.q-icon) { font-size: 3rem; }
