<template>
  <HeaderTitleBack v-if="isDown.pc" titleI18n="member.kyc.kyc_verify" variant="blueOrange">
  ...
  <!--第1步驟-->
  <div v-else-if="step === 1 && !isDown.pc" class="profile-container pc">
    ...
    <div class="profile-body">
      ...
      <div class="card">
        ...
        <div class="contentWrap">
          <div class="left">
            <div class="name">{{ t("member.kyc.double_check_scanned_details") }}</div>
            <div class="detail">
  ...
  <div v-else-if="step === 2 && !isDown.pc" class="profile-container pc">
    <div class="profile-header">
      <q-btn flat class="profile-header-title hide-hover" :to="{ name: 'memberProfile' }">
        <q-icon name="arrow_back" class=""></q-icon>
  ...
  <div v-else-if="step === 3 && !isDown.pc" class="profile-container pc">
    <div class="profile-header">
      <q-btn flat class="profile-header-title hide-hover" :to="{ name: 'memberProfile' }">
        <q-icon name="arrow_back" class=""></q-icon>
        {{ $t("member.kyc.kyc_status") }}
