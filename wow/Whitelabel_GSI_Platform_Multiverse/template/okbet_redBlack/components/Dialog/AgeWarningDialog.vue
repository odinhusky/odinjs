  ...
  <q-dialog v-model="dialog" persistent>
    ...
    >
      ...
      <q-card-section class="q-py-none warning-content-wrapper">
        ...
        <p v-if="isNS4M" class="text-justify text-sm mt-[1.5rem] text-white">
          Grup Telegram & Facebook resmi NUS45 menyiapkannotifikasi pembagian Angpao 🧧 serta Bonus Harian.Hanya member
          grup yang memperoleh informasi tersebut.Link grup dapat ditemukan di bagian bawah situs.
        </p>
