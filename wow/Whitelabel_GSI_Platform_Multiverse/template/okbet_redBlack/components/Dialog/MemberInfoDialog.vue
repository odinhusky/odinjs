...
.profile-dialog {
  .profile-body {
    ...
    gap: 0.9375rem;
    flex-wrap: wrap;
    @include phone-width { padding: 50px 30px; }

    .btn-close { @apply absolute right-0 top-0 m-1; }
    ...
    .input-container {
      ...
      :deep(.q-icon) { color: $white-color !important; }
      :deep(.q-field__native) { color: $white-color !important; }
      :deep(.q-field__control:before) { border-bottom: 1px solid $primary-red04 !important; }
      .select-placeholder {
        :deep(.q-field__inner) {
          .q-field__control {
            .q-field__native {
