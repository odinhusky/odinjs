<template>
  <HeaderTitleBack v-if="isMobile" titleI18n="member.profile.myDetails" variant="redBlack">
            ...
            <template v-if="needCountryCodePhone && dialog.info.column_name === COLUMN_NAME.Enums.PHONE">
              <div class="w-full p-5 flex flex-nowrap gap-2">
                <q-select
                  ...
                  class="md:w-2/6 w-[45%] pc-profile-input white-input-error custom-border"
                ...
                <q-input
                  ...
                  dense
                  class="dialog-form-input md:w-4/6 w-[55%] pc-profile-input white-input-error custom-border"
...
.profile-container.pc {
  ...
  .profile-body {
    ...
    .q-toggle {
      :deep(.q-toggle__label) { color: #ffffffcc; }
    }
