<template>
  <HeaderTitleBack v-if="isMobile" title-i18n="member.mail.messageCenter" variant="redBlack">
  ...
  <q-dialog v-model="modalShow" @hide="initMailDetail" :persistent="!isMobile">
    <q-card v-if="isMobile" class="dialog h5">
      ...
      <q-card-actions class="dialog-footer">
        <q-btn :label="$t('common.btn.confirm')" color="primary" text-color="black" v-close-popup />
      </q-card-actions>
    </q-card>
...
.dialog.pc {
  ...
  .dialog-body {
    ...
    padding-top: 20px;
    margin-bottom: 10px;
    border-top: 1px solid $primary-red02;
    font-size: 14px;
    flex-wrap: wrap;
    background: $primary-red01;
    .tips {
