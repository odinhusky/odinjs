<template>
  <HeaderTitleBack v-if="isMobile" :titleI18n="bankCardId ? 'common.btn.edit' : 'common.btn.add'" variant="redBlack">
    <q-form class="bank-add-layout h5" :class="{ '!pb-[24rem]': isTelegramMiniApp }" @submit="handleSubmit">
      ...
      <div class="action-btns row justify-center">
        <q-btn text-color="black" color="primary" :label="$t('common.btn.confirm')" class="submit-btn" type="submit" :disable="bankCardRealNameSubmissionBlocked" />
      </div>
    </q-form>
  </HeaderTitleBack>
