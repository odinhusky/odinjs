...
const MEMBER_ROUTE_CLASS = "okbet-redBlack-member-route"
watch(
  () => route.path,
  (path) => {
...
.member-layout {
  ...
  &.h5 {
    ...
    z-index: 1000;
    height: 100%;
    background: url("app/template/okbet_redBlack/assets/images/member/h5-bg.jpg") center / contain no-repeat #0d0000;
...
@media (min-width: 600px) and (max-width: 1025px) {
  body.okbet-redBlack-member-route {
