...
export const routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: "cmsHome/:cmsId",
        name: "CmsHome",
        component: () => import("app/template/set_r017/pages/CmsHome.vue")
      },
      {
      ...
      },
      {
        ...
        component: () => import("app/template/set_r017/pages/DigitainPage/Index.vue")
      },
      {
        path: "/betByPage",
        name: "BetByPage",
        component: () => import("app/template/set_r017/pages/BetByPage/Index.vue"),
        meta: {
      ...
      },
      {
        path: "/luckyPage",
        name: "LuckyPage",
        component: () => import("app/template/set_r017/pages/LuckyPage/Index.vue"),
        meta: {
          className: "p-0 h-full",
          hideLiveChat: true,
          needAuth: false
      ...
      },
      {
        path: "/referral",
        name: "Referral",
        component: () => import("app/template/set_r017/pages/Referral/Index.vue"),
        meta: {
          needAuth: true
        }
      },
      ...
      },
      {
        ...
        component: () => import("app/template/set_r017/pages/QuickPass/Index.vue")
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            path: "history",
            name: "history",
            component: () => import("app/template/set_r017/pages/Member/MemberHistory.vue")
          },
          {
            path: "inbox",
            name: "memberInbox",
          ...
          },
          {
            path: "interest",
            name: "memberInterest",
            component: () => import("app/template/set_r017/pages/Member/MemberInterest.vue")
          },
          {
            ...
            component: () => import("app/template/set_r017/pages/Member/MembershipManagement.vue")
          }
        ]
      },
      {
