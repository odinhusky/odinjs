...
.bonus-transfer-dialog {
  ...
  overflow: hidden;
  border-radius: 8px;
  background: var(--dialog-bg-02, #1e1335);
...
.summary-card__currency {
  ...
  padding: 4px 7px;
  border-radius: 12px;
  background: var(--tag-bg-01, #d2d2d21a);
...
.bonus-progress-panel {
  ...
  border-radius: 8px;
  background: linear-gradient(90deg, #290a45 0%, rgba(0, 0, 0, 0.6) 100%);
  ...
  &::before {
    ...
    background: linear-gradient(
      ...
      rgba(206, 67, 136, 0.6) -0.77%,
      rgba(210, 210, 210, 0.06) 67.58%,
      rgba(206, 67, 136, 0.6) 102.59%
    );
    content: "";
...
.bonus-progress-track__fill {
  height: 100%;
  border-radius: inherit;
  background: linear-gradient(0deg, #ce4388, #ce4388);
}
...
.bonus-transfer-all-btn {
  ...
  min-height: 35px;
  border-radius: 4px;
  background: var(--btn-bg-05, #ffffffc4);
...
.bonus-condition-row__icon-mask {
  ...
  width: 20px;
  height: 20px;
  background: var(--icon-04, var(--primany-01, #ce4388));
