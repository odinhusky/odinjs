<template>
  <div class="mobile-agent-container">
    ...
    <div class="condition-card-container">
      ...
      <MockGameFirst data-theme="set_r031" />
      <MockGameSecond data-theme="set_r031" />
      <MockGameThird data-theme="set_r031" />
    </div>
...
@import "app/template/set_r031/assets/css/agent.scss";
