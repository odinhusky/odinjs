              ...
              <div class="col-12 col-sm-12 mr-16">
                <ul class="bank-content col-12">
                  ...
                  <li class="w-full flex items-center !justify-between">
                    ...
                    <q-img @click="copyMessage(depositState.paymentDetail.bank_name)" :src="copyIcon"></q-img>
                  </li>
                  <li class="w-full flex items-center !justify-between">
                    <span>{{ depositState.paymentDetail.bank_account }}</span>
                    <q-img @click="copyMessage(depositState.paymentDetail.bank_account)" :src="copyIcon"></q-img>
                  </li>
                  <img
              ...
              <div class="col-12 col-sm-12 mr-16">
                ...
                <ul class="bank-content col-12">
                  ...
                  <li class="w-full flex items-center !justify-between">
                    ...
                    <q-img @click="copyMessage(depositState.paymentDetail.wallet_address)" :src="copyIcon"></q-img>
                  </li>
                  <img
                    v-if="depositState.paymentDetail.qrcode_image_id !== 0"
                    :src="depositState.paymentDetail.imgUrl"
