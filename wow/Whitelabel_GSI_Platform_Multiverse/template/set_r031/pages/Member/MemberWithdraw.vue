      ...
      <q-form @submit="handleWithdralSubmit">
        <div class="profile-form column">
          <div class="form-content">
                ...
                <div class="wrap">
                  <table>
                    <tr>
                      ...
                      <!-- <th>{{ $t("member.withdrawal.withdrawable_balance") }}</th> -->
                    </tr>
                    <tr>
            ...
            <!-- currency -->
            <div v-if="showSetR031WithdrawCurrencyArea" class="form-item row">
            ...
            <!-- type -->
            <div v-if="showWithdrawTypeArea" class="form-item row">
              ...
              <div class="row col-12">
                ...
                <div class="btn-content col-12">
                  <q-input
                    ...
                    lazy-rules
                    :placeholder="`${
                      withdrawState.paymentDetail.withdraw_min && withdrawState.paymentDetail.withdraw_max
                        ? $t('member.withdrawal.amount_input', {
                            min: withdrawState.paymentDetail.withdraw_min,
                            max: withdrawState.paymentDetail.withdraw_max,
                          })
                        : $t('member.deposit.withdrawAmount')
                    }`"
            ...
            <div class="form-item mb-2" v-show="withdrawState.form.crypto_rate">
              <ul>
                <li>
...
const _$q = useQuasar()
const { accountInfo, userWalletMap, useBasicInfoQuery } = useUserInfo()
useBasicInfoQuery()
const {} = useI18n()
const {
  gatewayFilterList,
...
const showSetR031WithdrawCurrencyArea = computed(() => withdrawState.supportedCurrency.length > 0)
...
.withdrawal-kyc-container {
  @apply flex items-center mt-2 mb-2 p-[.5rem] rounded-[.25rem] w-full max-w-[560px];
  background: $primany04;
  color: $neutral10;
