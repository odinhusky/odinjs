  ...
  <div class="collaboration-wrapper">
    ...
    <div class="collaboration-content">
      <div class="collaboration-header">
        ...
        <q-icon name="help" class="collaboration-info-btn" @click="dialog = true" />
      </div>
          ...
          <div class="referral-code-content">
            ...
            <div class="referral-code-row">
              ...
              <div class="referral-code-btn">
                ...
                />
                <q-icon name="content_copy" @click="copyMessage(collaborationState.referral_code)" />
              </div>
            </div>
          </div>
        </div>
...
import BaseDialog from "app/template/set_r031/components/Dialog/BaseDialog.vue"
...
@import "app/template/set_r031/assets/css/table.scss";
@import "app/template/set_r031/assets/css/form2.scss";
...
.collaboration-wrapper {
  ...
  .collaboration-content {
    ...
    .collaboration-tab-panels {
      @apply mt-4 p-1 flex flex-col gap-10 bg-[var(--secondary-06)];
