          ...
          <template v-slot:selected>
            <div class="flex flex-row align-center w-[13.75rem] phone:w-auto">
              <img
                ...
                :src="getProductTabImage({ ...selectedProduct, siteKey: 'set_r031' })"
          ...
          <template v-slot:option="scope">
            <q-item v-bind="scope.itemProps" :key="scope.opt.value">
              <q-item-section avatar>
                <img
                  :src="getProductTabImage({ product_code: scope.opt.value, siteKey: 'set_r031' })"
                  :class="cx('provider-img', 'w-auto')"
                  :alt="scope.opt.value"
                  @error="setDefaultProductTabImg"
                />
        ...
        <ul :key="`game-row-${index}`" class="game-row">
          ...
          >
            <div class="img-container">
              ...
              <div
                v-if="isDesktop ? hoveredGameId === game.game_id : selectedGameId === game.game_id"
                class="play-btn-container"
                :class="{ show: selectedGameId === game.game_id && !isDesktop }"
              >
                <q-btn
...
import GameBanner from "app/template/set_r031/components/Banner/GameBanner.vue"
import GameTab from "app/template/set_r031/components/Tab/GameTab.vue"
...
@import "app/template/set_r031/assets/css/form.scss";
@import "app/template/set_r031/assets/css/common.scss";
@import "app/template/set_r031/assets/css/game.scss";
