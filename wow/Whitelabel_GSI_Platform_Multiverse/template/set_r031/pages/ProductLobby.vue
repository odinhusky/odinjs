    ...
    <ul class="product-list">
      ...
      >
        <div class="img-container">
          <q-img
            :src="getProductSquareImage({ ...product, siteKey: 'set_r031' })"
...
import RankBoard from "app/template/set_r031/components/Carousel/RankBoard.vue"
...
const gameTypeId = computed(() =>
  GAME_TYPE.isGameType(parsedGameTypeId.value) ? parsedGameTypeId.value : GAME_TYPE.Enums.SLOT
)
...
@import "app/template/set_r031/assets/css/product.scss";
