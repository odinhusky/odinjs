      ...
      <q-card-section class="password-edit-container">
        ...
        <div class="container">
          ...
          <div class="btn-area">
            ...
            <q-btn outline class="btn-style cancel" @click="resetWithdrawalPasswordForm()">{{ $t("common.btn.reset") }}</q-btn>
          </div>
        </div>
      </q-card-section>
    </q-card>
...
.password-edit-dialog {
  ...
  @include pad-large-width { background: var(--bg-main-bg); }
  ...
  .password-edit-container {
    ...
    .container {
      @include pad-large-width { padding: 0.9375rem; }
            ...
            :deep(.q-field__inner) {
              ...
              .q-field__prepend {
                ...
                .form-icon {
                  ...
                  @include pad-large-width { margin: unset; }
              ...
              .q-field__control-container {
                ...
                @include pad-large-width { font-size: 0.9647rem; }
      ...
      .btn-area {
        ...
        .btn-style {
          ...
          &.cancel {
            ...
            &::before { border: 0.125rem solid var(--primary-01); }
          }

          :deep(.q-btn__content) { line-height: normal; }
        }
      }
    }
  }
