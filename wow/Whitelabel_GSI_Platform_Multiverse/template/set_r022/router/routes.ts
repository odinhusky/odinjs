  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "/digitainPage",
        name: "DigitainPage",
        component: () => import("app/template/set_r022/pages/DigitainPage/Index.vue"),
        meta: {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import("app/template/set_r022/pages/MemberCenter/MembershipManagement/Index.vue")
      },
      // {
      //   path: "freeSpin",
      //   name: "FreeSpin",
      //   component: () => import("app/template/set_r022/pages/FreeSpin/Index.vue")
      // }
    ]
  }
] as RouteRecordRaw[]
