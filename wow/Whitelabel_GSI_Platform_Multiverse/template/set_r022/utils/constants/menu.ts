export const WalletRouteNames = new Set(["MemberDeposit", "MemberWithdrawal"])

export const WalletTypeToRouteName: Record<string, string> = {
...
export const RouterNameMapping: Record<string, string> = {
  ...
  announcement_center: "AnnouncementCenter",
