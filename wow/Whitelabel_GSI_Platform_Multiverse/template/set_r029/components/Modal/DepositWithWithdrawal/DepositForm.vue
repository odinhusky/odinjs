<template>
  <section class="deposit-wrapper">
    <!-- 幣別選擇 -->
    <div v-if="showDepositCurrencyArea" class="pay-area">
    ...
    <!-- 支付方式選擇 -->
    <div v-if="showDepositTypeArea" class="pay-area">
    ...
    <q-form class="payment-form" @submit="handleSubmit">
      ...
      <div class="form-row pay-area" v-if="depositState.usingFundType === 'BankTransfer'">
        ...
        <ul class="bank-account">
          <li class="mb-2">
            ...
            <q-icon class="content_copy" name="content_copy" @click="copyMessage(depositState.paymentDetail.bank_name)" />
          </li>
          <li class="mb-2">
            <span class="mr-2">{{ depositState.paymentDetail.bank_account }}</span>
            <q-icon class="content_copy" name="content_copy" @click="copyMessage(depositState.paymentDetail.bank_account)" />
          </li>
        </ul>
        <img
      ...
      <div class="form-row pay-area" v-if="depositState.usingFundType === 'CryptoWallet'">
        ...
        <ul class="bank-account">
          ...
          <li class="mb-2">
            ...
            <q-icon class="content_copy" name="content_copy" @click="copyMessage(depositState.paymentDetail.wallet_address)" />
          </li>
        </ul>
        <img
          v-if="depositState.paymentDetail.qrcode_image_id !== 0"
      ...
      <div class="form-row field-input flex flex-col pay-area">
        ...
        >
          <template #prepend>
            <img src="~app/template/set_r029/assets/images/svg/coins.svg" alt="coins">
          </template>
        </q-input>
      ...
      <div class="form-row field-input flex flex-col pay-area" v-if="depositState.paymentDetail.extra_field_key">
        ...
        >
          ...
          <ExtraSelect
            ...
            :field="field"
            class="form-input"
            popup-content-style="background-color: #111827; color: #F9FAFB;"
          ></ExtraSelect>
          <!-- 其他 -->
          <ExtraInput
            v-else
