  ...
  >
    <div class="details-wrapper">
      <section class="card-layout">
        ...
        >
          <div class="edit-bank">
            <i class="fas fa-trash text-edit" @click="openConfirm(item.id, item.crypto_rate)"></i>
            <i
      ...
      <q-card class="payment-card">
        <q-form @submit="submitForm()" class="currency-wrapper">
          ...
          <q-card-section class="currency-list">
            ...
            >
              <div class="field-input">
                <span class="form-title">{{ $t(getBankCardRealNameLabel('member.bank.accountName')) }}</span>
                <q-input
                  ...
                  lazy-rules
                  :rules="[Rules.required()]"
                  :label="$t(getBankCardRealNameLabel('member.bank.accountName'))"
                >
                  <template v-slot:prepend>
          ...
          <div class="details-btn-wrapper">
            ...
            <q-btn class="btn-submit" type="submit" :disable="bankCardRealNameSubmissionBlocked" :loading="isLoading">
              {{ $t("common.btn.submit") }}
            </q-btn>
          </div>
        </q-form>
...
.payment-type-container {
  ...
  li {
    @apply flex items-center justify-center cursor-pointer p-[.625rem];
    @apply text-sm rounded-[.3125rem];
...
.currency-wrapper {
  .currency-list {
    @apply p-[1.25rem] mb-[.9375rem] rounded-lg;
  ...
  .currency-btn-wrapper {
    @apply grid gap-[.9375rem];
    grid-template-columns: repeat(3, 1fr);
  }

  .currency-btn {
    @apply flex items-center justify-center cursor-pointer rounded-[.3125rem];
    @apply p-[.625rem];
    font-size: 0.75rem;
    background: $r029-bg-card;
    border: 1px solid $r029-bg-section;
    color: $r029-text-primary;
...
.delete-card {
  ...
  .delete-card-header {
    @apply flex items-center justify-center capitalize;
    background: $r029-bg-card;
    color: $r029-error;
  ...
  .btn-delete-confirm {
    @apply capitalize;
    background: $r029-action-primary !important;
    color: $r029-bg-home;
