...
.transaction-history-list {
  ...
  .expansion-header {
    ...
    .header-content {
      ...
      .content-left {
        border-right: 0.0625rem solid $r029-bg-card;
      }
  ...
  .expansion-card {
    border-top: 0.0625rem solid $r029-bg-card !important;
    background: $r029-bg-section;

    .table-title {
      @apply flex justify-center items-center font-bold p-[.625rem];
      background: $r029-bg-card;
      color: $r029-text-primary;
    }

    .odd-bg {
      border-top: 0.0625rem solid $r029-bg-card;
      border-bottom: 0.0625rem solid $r029-bg-card;
    }
