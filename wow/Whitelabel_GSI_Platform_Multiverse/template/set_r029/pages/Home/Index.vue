...
import HomeBanner from "app/template/set_r029/pages/Home/components/HomeBanner.vue"
import Navigator from "app/template/set_r029/pages/Home/components/Navigator.vue"
import ProviderList from "app/template/set_r029/pages/Home/components/ProviderList.vue"
import RankBoard from "app/template/set_r029/pages/Home/components/RankBoard.vue"
...
const handleCarouselArrow = (cmsIndex: number, direction: "prev" | "next") => {
  const cmsList = cmsHomeList.value
...
.home-container {
  ...
  .marquee-wrapper {
    @apply relative w-full py-3 pl-[2.5625rem] rounded-[999px] mt-5;
        ...
        .home-title-container {
          ...
          .all {
            ...
            .arrow {
              ...
              border-color: $r029-bg-card !important;
