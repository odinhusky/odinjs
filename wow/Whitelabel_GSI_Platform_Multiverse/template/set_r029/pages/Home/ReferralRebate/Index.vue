                  ...
                  <div class="date-action">
                    <div class="date-select">
                      ...
                      <q-dialog v-model="isShowDatePicker" position="standard">
                        ...
                        <q-card class="q-pa-none" style="--q-primary: #22C55E">
...
<!--
  set_r029 無亮暗模式。q-date popup 是 teleport 到 body 的，直接用全局 .q-date 覆蓋。
  顏色對應 _variable.scss：
...
// ── q-date popup 覆蓋（set_r029：無亮暗模式）────────────────────────
...
@import "app/template/set_r029/assets/css/_variable.scss";
@import "app/template/set_r029/assets/css/referral-rebate.scss";
</style>
