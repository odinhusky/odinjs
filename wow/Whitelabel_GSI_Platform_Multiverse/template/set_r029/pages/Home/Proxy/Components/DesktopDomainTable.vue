    ...
    <q-card class="desktop-domain-dialog">
      <q-form @submit="submit">
        <q-card-section class="flex items-center p-0">
          <p class="pt-2 text-[1.8125rem] font-normal">{{ $t("collaboration.add_domain_application") }}</p>
          <q-space />
        ...
        <q-card-section class="domain-box py-[2.1875rem] px-[3.125rem] mt-[.6875rem]">
          ...
          <p class="mt-10">
            {{ host }}
            <q-icon name="fa-solid fa-copy" class="cursor-pointer" @click="copyMessage(host)"></q-icon>
          </p>
        </q-card-section>
...
.btn-add {
  @apply px-[2.5rem] py-3 rounded-[0.5rem] mb-4;
...
.referral-table-content {
  ...
  :deep(.q-table__middle) {
    ...
    td {
      color: $r029-text-primary;
      border-top: 1px solid $r029-bg-card;
