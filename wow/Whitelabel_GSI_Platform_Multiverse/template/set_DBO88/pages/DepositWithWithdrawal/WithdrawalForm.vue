    ...
    <q-form @submit="handleWithdralSubmit()">
      ...
      <div class="balance-wrapper">
        <div class="field-input flex flex-col gap-[10px] pt-[10px]">
          ...
          <q-input :model-value="moneyFormat(withdrawState.form.balance)" outlined :disable="true">
        ...
        <div class="field-input flex flex-col gap-[10px] pt-[10px]">
          ...
          <q-input :model-value="moneyFormat(withdrawState.form.remaining_turnover)" outlined :disable="true">
            <template v-slot:prepend>
