<template>
  ...
  >
    <div class="phone-group form-input !px-3 md:!px-0 !pt-0">
      <q-select
        v-if="countryFiled"
        ...
        :option-value="countryOptionValue"
        :option-label="countryOptionLabel"
        :dense="true"
...
const countryOptionValue = (opt: CountryOption) => opt.value
const countryOptionLabel = (opt: CountryOption) => opt.label
...
.phone-group {
  // Quasar uses `var(--q-primary)` for focused border. Override it to green color
  --q-primary: #{$primany-01};
