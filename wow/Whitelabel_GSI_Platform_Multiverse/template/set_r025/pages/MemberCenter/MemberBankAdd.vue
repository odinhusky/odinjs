<template>
  <HeaderTitleBack v-if="isDown.pc" :titleI18n="bankCardId ? 'common.btn.edit' : 'common.btn.add'" variant="setR025">
    <q-form class="bank-add-layout h5" :class="{ '!pb-[24rem]': isTelegramMiniApp }" @submit="handleSubmit">
      ...
      <div class="action-btns row justify-center">
        <q-btn text-color="white" color="primary" class="submit-btn" type="submit" :disable="bankCardRealNameSubmissionBlocked">
        ...
        <div class="profile-form column">
          ...
          <q-form class="form-content" @submit="handleSubmit">
            ...
            <div class="action-btns multi-btns row justify-center no-wrap">
              ...
              <q-btn text-color="black" color="primary" class="submit-btn" type="submit" :disable="bankCardRealNameSubmissionBlocked">
                {{ $t("common.btn.confirm") }}
              </q-btn>
            </div>
          </q-form>
