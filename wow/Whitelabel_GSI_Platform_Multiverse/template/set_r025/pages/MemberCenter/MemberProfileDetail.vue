<template>
  <HeaderTitleBack v-if="isDown.pc" titleI18n="member.profile.myDetails" variant="setR025">
...
.profile-container.pc {
  ...
  .profile-body {
    ...
    .input-container {
      ...
      :deep(.q-field__append) { color: $neutral-01; }
      .select-placeholder {
        :deep(.q-field__inner) {
          .q-field__control {
            i { color: $neutral-01 !important; }
            ...
            .q-field__native {
              span { color: $functional-btn-text-secondary; }
            }
          }
        }
      }
  ...
  .dialog-card {
    ...
    .dialog-body {
      .dialog-form-row {
        ...
        :deep(.q-field__control) {
          color: $primany-01;
          &::before { border-color: $neutral-01; }

          .q-field__native { color: $neutral-01; }
        }
    ...
    @include phone-width {
      ...
      .dialog-body {
        :deep(.q-field__control) {
          ...
          .q-field__native,
          .q-field__append { color: $neutral-01; }
        }
