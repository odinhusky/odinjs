<template>
  <div v-if="isDown.pc" class="member-layout h5">
    ...
    <div class="member-container">
      <div class="member-left">
        <div class="member-info">
          ...
          <div class="info-row info-row--identity-hidden">
          ...
          <div class="info-row">
            <span class="info-row-left">
              ...
              <div v-if="inUseWallet" class="label money wallet-balance-list">
...
const MEMBER_ROUTE_CLASS = "set-r025-member-route"
watch(
  () => route.path,
  (path) => {
